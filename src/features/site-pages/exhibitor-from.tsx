...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-80 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-80" />
      ...
      <link rel="stylesheet" id="elementor-post-80-css" href="/css/elementor-post-80.css" media="all" />
      ...
      <link rel="stylesheet" id="elementor-post-14793-css" href="/css/elementor-post-14793.css" media="all" />
      <link rel="stylesheet" id="widget-form-css" href="/css/elementor-pro-widget-form.css" media="all" />
...
`
      ...
      <style id="style-inline-exhibitor-from-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-exhibitor-from-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-exhibitor-from-7" dangerouslySetInnerHTML={{
        __html: `
/* ===== Scoped to .ayv-exhibitor-page — safe to paste alongside other widgets ===== */
.ayv-exhibitor-page{font-family:'Poppins',Arial,sans-serif;background:#fbf7f2;color:#2b2024;line-height:1.6}
.ayv-exhibitor-page *{box-sizing:border-box}
.ayv-wrap{max-width:1180px;margin:0 auto;padding:0 24px}
.ayv-section{padding:70px 0}
.ayv-section-alt{background:#f4e9ee}

/* Hero */
.ayv-hero{position:relative;overflow:hidden;padding:100px 0 90px;background:linear-gradient(135deg,#5c1330,#8f1f4b 55%,#b2245a);color:#fff}
.ayv-hero-grid{display:grid;grid-template-columns:1.3fr .7fr;gap:50px;align-items:center;position:relative;z-index:2}
.ayv-eyebrow{display:inline-block;letter-spacing:1.5px;font-size:13px;font-weight:700;color:#ffd9a8;background:rgba(255,255,255,.12);padding:7px 16px;border-radius:30px}
.ayv-hero h1.ayv-h1{font-size:46px;line-height:1.18;margin:20px 0 16px;font-weight:700;color:#fff!important}
.ayv-lead{font-size:17px;max-width:560px;color:#f3dfe6}
.ayv-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin:32px 0 28px;max-width:560px}
.ayv-stat{background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.18);border-radius:14px;padding:16px 8px;text-align:center}
.ayv-stat b{display:block;font-size:26px;color:#ffd46c;font-weight:700}
.ayv-stat span{font-size:12px;color:#f0d8e0}
.ayv-btn{display:inline-block;padding:14px 30px;border-radius:40px;font-weight:700;text-decoration:none;font-size:15px;transition:transform .15s ease}
.ayv-btn:hover{transform:translateY(-2px)}
.ayv-btn-light{background:#fff;color:#7a1a40}
.ayv-hero-art{position:relative;height:320px}
.ayv-hero-ring{position:absolute;border-radius:50%;border:2px solid rgba(255,255,255,.25)}
.ayv-hero-ring{width:280px;height:280px;top:10px;right:30px}
.ayv-ring-2{width:180px;height:180px;top:80px;right:90px;border-color:rgba(255,212,108,.5)}

/* Enquiry section */
.ayv-tag{display:inline-block;font-size:12px;font-weight:700;letter-spacing:1px;color:#9c2a57;background:#fbe3ec;padding:6px 14px;border-radius:30px}
.ayv-tag-light{background:rgba(255,255,255,.15);color:#ffd9e6}
.ayv-h2{font-size:32px;color:#6b1737;margin:16px 0 18px;line-height:1.25}
.ayv-p{color:#5a4a4f;font-size:15.5px}
.ayv-enquiry-grid{display:flex;flex-direction:column;gap:40px;max-width:900px;margin:0 auto}
.ayv-event-meta{display:flex;gap:30px;margin-top:26px;flex-wrap:wrap}
.ayv-meta-item{display:flex;flex-direction:column}
.ayv-meta-label{font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#a8748a}
.ayv-meta-value{font-weight:700;color:#6b1737;font-size:15px}

.ayv-form-card{background:#fff;border-radius:22px;padding:34px 44px;box-shadow:0 18px 45px rgba(107,23,55,.14);border:1px solid #f1dce4;width:100%}
.ayv-form-card h3{margin:0 0 8px;color:#6b1737;font-size:22px}
.ayv-form-sub{color:#7a6a6e;font-size:14px;margin-bottom:10px}
.ayv-form-contact{display:flex;gap:18px;flex-wrap:wrap;font-size:13.5px;color:#5a4a4f;margin-bottom:20px}
.ayv-form-contact a{color:#6b1737;font-weight:600;text-decoration:none}
.ayv-form-contact a:hover{text-decoration:underline}
.ayv-shortcode-slot{padding:20px;border:2px dashed #d5ad5d;border-radius:14px;background:#fffaf1;font-size:13px;color:#8a7a4a;word-break:break-all}
.ayv-shortcode-note{margin-top:10px;font-size:12px;color:#a08;opacity:.7}

/* Categories */
.ayv-heading{text-align:center;font-size:32px;color:#6b1737;margin-bottom:10px}
.ayv-heading-sub{text-align:center;color:#7a6a6e;font-size:14.5px;max-width:640px;margin:0 auto 36px}
.ayv-cat-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:14px}
.ayv-cat{background:#fff;border:1px solid #ecd6de;border-radius:12px;padding:14px 16px;font-size:14px;color:#5a4a4f;font-weight:500;position:relative;padding-left:38px}
.ayv-cat::before{content:'✓';position:absolute;left:14px;top:13px;color:#fff;background:#b2245a;width:18px;height:18px;border-radius:50%;font-size:11px;line-height:18px;text-align:center}

/* Why exhibit cards */
.ayv-cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:22px}
.ayv-card{background:#fff;border-radius:16px;padding:28px 24px;box-shadow:0 8px 24px rgba(0,0,0,.06);border:1px solid #f1e3e8}
.ayv-card-icon{font-size:20px;width:42px;height:42px;border-radius:50%;background:#fbe3ec;color:#9c2a57;display:flex;align-items:center;justify-content:center;font-weight:700;margin-bottom:14px}
.ayv-card h4{margin:0 0 8px;color:#6b1737;font-size:18px}
.ayv-card p{margin:0;color:#6a5a5e;font-size:14px}

/* CTA banner */
.ayv-cta{padding:80px 0;text-align:center;background:linear-gradient(135deg,#5c1330,#8f1f4b);color:#fff}
.ayv-cta-inner{max-width:640px}
.ayv-cta h2{font-size:30px;margin:18px 0 14px;color:#fff!important}
.ayv-cta p{color:#fff!important;font-size:15.5px;margin-bottom:26px}

/* Contact strip */
.ayv-contact-strip{background:#fff}
.ayv-contact-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:30px}
.ayv-contact-block{border-left:3px solid #b2245a;padding-left:18px}
.ayv-contact-block h5{margin:0 0 8px;color:#6b1737;font-size:15px;letter-spacing:.3px}
.ayv-contact-block p{margin:2px 0;font-size:14px}
.ayv-contact-block a{color:#5a4a4f;text-decoration:none}
.ayv-contact-block a:hover{color:#b2245a}

/* Elementor form styling overrides, scoped */
.ayv-form-card .elementor-widget-container{background:#fff;border-radius:16px}

.ayv-form-card .elementor-field-group > label{
  display:block;
  margin-bottom:6px;
  font-weight:600;
  color:#3a2c30;
...
.ayv-form-card .elementor-field,
.ayv-form-card input[type="text"],
.ayv-form-card input[type="email"],
.ayv-form-card input[type="tel"],
.ayv-form-card input[type="number"],
.ayv-form-card select,
.ayv-form-card textarea{
  border-radius:12px!important;
  border:1.5px solid #e6d2da!important;
...
.ayv-form-card input::placeholder,
.ayv-form-card textarea::placeholder{
  color:#b89aa4!important;
  opacity:1;
}
.ayv-form-card input:focus,
.ayv-form-card select:focus,
.ayv-form-card textarea:focus{
  outline:none!important;
  border-color:#b2245a!important;
  background:#fff!important;
  box-shadow:0 0 0 3px rgba(178,36,90,.12)!important;
}
.ayv-form-card select{
  appearance:none;
  -webkit-appearance:none;
  background-image:url('data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='14' height='9' viewBox='0 0 14 9'><path d='M1 1l6 6 6-6' stroke='%236b1737' stroke-width='2' fill='none' fill-rule='evenodd'/></svg>');
...
.ayv-form-card .elementor-field-type-checkbox .elementor-field-subgroup,
.ayv-form-card .elementor-field-type-radio .elementor-field-subgroup{
...
.ayv-form-card .elementor-field-type-checkbox .elementor-field-option,
.ayv-form-card .elementor-field-type-radio .elementor-field-option{
  display:flex!important;
...
.ayv-form-card .elementor-field-option label{
  ...
  color:#3a2c30!important;
}
.ayv-form-card .elementor-field-type-checkbox input[type="checkbox"],
.ayv-form-card .elementor-field-type-radio input[type="radio"]{
...
/* Submit button */
.ayv-form-card .elementor-button{
  width:100%;
  border-radius:50px!important;
  background:#6b1737!important;
  color:#fff!important;
...
.ayv-form-card .elementor-button:hover{
  background:#8f1f4b!important;
  transform:translateY(-1px);
}

/* Field spacing rhythm */
.ayv-form-card .elementor-field-group{
  margin-bottom:18px!important;
}

/* Force the embedded form into a single column (overrides Elementor's
   default 2-col field-group grid, e.g. Company Name | Contact Person) */
.ayv-form-card .elementor-form-fields-wrapper{
  display:flex!important;
  flex-direction:column!important;
}
.ayv-form-card .elementor-field-group,
.ayv-form-card .elementor-field-type-text,
.ayv-form-card .elementor-field-type-email,
.ayv-form-card .elementor-field-type-tel,
.ayv-form-card .elementor-field-type-select,
.ayv-form-card .elementor-field-type-textarea,
.ayv-form-card .elementor-field-type-checkbox,
.ayv-form-card .elementor-col-50,
.ayv-form-card .elementor-col-33,
.ayv-form-card .elementor-col-25{
  width:100%!important;
  max-width:100%!important;
...
/* Checkbox list (product categories inside the form) stays single column too */
.ayv-form-card .elementor-field-type-checkbox .elementor-field-subgroup{
  display:flex!important;
  flex-direction:column!important;
  gap:8px;
...
@media(max-width:900px){
  ...
  .ayv-hero-art{display:none}
  .ayv-h1{font-size:34px}
  .ayv-stats{grid-template-columns:repeat(2,1fr)}
  .ayv-enquiry-grid{grid-template-columns:1fr}
  .ayv-contact-grid{grid-template-columns:1fr;gap:24px}
}
@media(max-width:560px){
  .ayv-stats{grid-template-columns:1fr 1fr}
  .ayv-section{padding:50px 0}
  .ayv-h1{font-size:28px}
}
`
      }} />
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-14873"><a class="elementor-item elementor-item-anchor" href="#">Exhibitor</a>
<ul class="sub-menu elementor-nav-menu--dropdown">
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-80 current_page_item menu-item-14326"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/exhibitor-from">Exhibitor Interest Form</a></li>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-14873"><a class="elementor-item elementor-item-anchor" href="#" tabindex="-1">Exhibitor</a>
<ul class="sub-menu elementor-nav-menu--dropdown">
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-80 current_page_item menu-item-14326"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/exhibitor-from" tabindex="-1">Exhibitor Interest Form</a></li>
...
<div class="elementor elementor-80" data-elementor-id="80" data-elementor-post-type="page" data-elementor-type="wp-page">
<div class="elementor-element elementor-element-11879b8 e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="11879b8">
<div class="elementor-element elementor-element-ed2ed4b elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="ed2ed4b" data-widget_type="html.default">
<div class="elementor-widget-container">
<!-- ============================================================
  AYURVED YASHOBHOOMI 2026 — EXHIBITOR ENQUIRY PAGE
  Paste this entire block into a single Elementor "Custom HTML" widget.
  Layout reference: ayurmahotsava.com/exhibitor (hero+stats, intro+form,
  product-category checklist, CTA banner, contact strip).
  Branding: maroon/wine/plum, scoped with .ayv- prefix to avoid theme clashes.
  Replace the shortcode placeholder with your real Elementor form template ID.
============================================================= -->
<div class="ayv-exhibitor-page">
<!-- ============ HERO ============ -->
<section class="ayv-hero">
<div class="ayv-wrap ayv-hero-grid">
<div class="ayv-hero-copy">
<span class="ayv-eyebrow">WHY EXHIBIT WITH US?</span>
<h1 class="ayv-h1">Be Part of India's Leading<br/>Ayurveda Movement</h1>
<p class="ayv-lead">
<strong>Ayurved Yashobhoomi 2026</strong> offers a platform to connect with
          Ayurveda practitioners, hospitals, distributors and wellness professionals —
          while growing your business in the AYUSH sector.
        </p>
<div class="ayv-stats">
<div class="ayv-stat"><b>2500+</b><span>Doctors</span></div>
<div class="ayv-stat"><b>50+</b><span>Exhibitors</span></div>
<div class="ayv-stat"><b>20K+</b><span>Visitors</span></div>
<div class="ayv-stat"><b>600+</b><span>Papers</span></div>
</div>
<a class="ayv-btn ayv-btn-light" href="#ayv-enquiry">Reserve Your Stall</a>
</div>
<div aria-hidden="true" class="ayv-hero-art">
<div class="ayv-hero-ring"></div>
<div class="ayv-hero-ring ayv-ring-2"></div>
</div>
</div>
</section>
<!-- ============ ENQUIRY SECTION ============ -->
<section class="ayv-section" id="ayv-enquiry">
<div class="ayv-wrap ayv-enquiry-grid">
<!-- Intro copy -->
<div class="ayv-enquiry-intro">
<span class="ayv-tag">EXHIBITOR ENQUIRY</span>
<h2 class="ayv-h2">Showcase Your Brand at<br/>Ayurved Yashobhoomi 2026</h2>
<p class="ayv-p">
          Register as an exhibitor and showcase your Ayurvedic products, wellness
          solutions, herbal innovations and healthcare services to thousands of
          visitors, delegates, doctors, researchers and industry professionals.
          The exhibition offers valuable opportunities for brand visibility,
          B2B networking, product promotion and collaborations within the
          growing Ayurveda &amp; AYUSH ecosystem.
        </p>
<div class="ayv-event-meta">
<div class="ayv-meta-item">
<span class="ayv-meta-label">Dates</span>
<span class="ayv-meta-value">23–24 December 2026</span>
</div>
<div class="ayv-meta-item">
<span class="ayv-meta-label">Venue</span>
<span class="ayv-meta-value">Shri Prem Nagar Ashram, Haridwar</span>
</div>
</div>
</div>
<!-- Form card -->
<div class="ayv-form-card">
<h3>Exhibitor Enquiry Form</h3>
<p class="ayv-form-sub">Showcase your products, innovations and services at Ayurved Yashobhoomi 2026</p>
<p class="ayv-form-contact">
<span>📞 <a href="tel:+918318714809">+91 83187 14809</a></span>
<span>✉️ <a href="mailto:info@ayurvedamfoundation.com">info@ayurvedamfoundation.com</a></span>
</p>
<!--
          Replace the line below with your real Elementor form shortcode/template,
          e.g. [elementor-template id="14793"]
          If shortcodes don't render inside Custom HTML widgets, drop an
          Elementor "Shortcode" widget directly underneath this block instead.
        -->
<div class="ayv-shortcode-slot">
<div class="elementor elementor-14793" data-elementor-id="14793" data-elementor-post-type="elementor_library" data-elementor-type="section">
<section class="elementor-section elementor-top-section elementor-element elementor-element-544499d elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="544499d" data-settings='{"background_background":"classic"}'>
<div class="elementor-background-overlay"></div>
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-57c0fb7" data-e-type="column" data-element_type="column" data-id="57c0fb7" data-settings='{"background_background":"classic"}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-159c19b elementor-button-align-start elementor-widget elementor-widget-form" data-e-type="widget" data-element_type="widget" data-id="159c19b" data-settings='{"step_next_label":"Next","step_previous_label":"Previous","button_width":"100","step_type":"number_text","step_icon_shape":"circle"}' data-widget_type="form.default">
<div class="elementor-widget-container">
<form aria-label="Exhibitor Registration Form" class="elementor-form" method="post" name="Exhibitor Registration Form">
<input name="post_id" type="hidden" value="14793"/>
<input name="form_id" type="hidden" value="159c19b"/>
<input name="referer_title" type="hidden" value="Exhibitor Interest Form"/>
<input name="queried_id" type="hidden" value="80"/>
<div class="elementor-form-fields-wrapper elementor-labels-above">
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-50">
<label class="elementor-field-label" for="form-field-name">
								Company Name							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-name" name="form_fields[name]" placeholder="Your Company Name" size="1" type="text"/>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_06b9827 elementor-col-50">
<label class="elementor-field-label" for="form-field-field_06b9827">
								Contact Person Name							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_06b9827" name="form_fields[field_06b9827]" placeholder="Your Contact Person Name" size="1" type="text"/>
</div>
<div class="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-field_0850110 elementor-col-50">
<label class="elementor-field-label" for="form-field-field_0850110">
								Mobile Number							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_0850110" name="form_fields[field_0850110]" pattern="[0-9()#&amp;+*-=.]+" placeholder="Your Mobile Number" size="1" title="Only numbers and phone characters (#, -, *, etc) are accepted." type="tel"/>
</div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-50 elementor-field-required">
<label class="elementor-field-label" for="form-field-email">
								Email							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-email" name="form_fields[email]" placeholder="Your Email" required="required" size="1" type="email"/>
</div>
<div class="elementor-field-type-select elementor-field-group elementor-column elementor-field-group-field_c03bc19 elementor-col-100">
<label class="elementor-field-label" for="form-field-field_c03bc19">
								Category of Exhibitor							</label>
<div class="elementor-field elementor-select-wrapper remove-before">
<div class="select-caret-down-wrapper">
<svg aria-hidden="true" class="e-font-icon-svg e-eicon-caret-down" viewbox="0 0 571.4 571.4" xmlns="http://www.w3.org/2000/svg"><path d="M571 393Q571 407 561 418L311 668Q300 679 286 679T261 668L11 418Q0 407 0 393T11 368 36 357H536Q550 357 561 368T571 393Z"></path></svg> </div>
<select class="elementor-field-textual elementor-size-sm" id="form-field-field_c03bc19" name="form_fields[field_c03bc19]">
...
<div class="elementor-field-type-checkbox elementor-field-group elementor-column elementor-field-group-field_b8a4da8 elementor-col-100">
<label class="elementor-field-label" for="form-field-field_b8a4da8">
								Category of Exhibitor							</label>
<div class="elementor-field-subgroup elementor-subgroup-inline"><span class="elementor-field-option"><input id="form-field-field_b8a4da8-0" name="form_fields[field_b8a4da8][]" type="checkbox" value="Ayurvedic, Unani &amp; Siddha Medicines"/> <label for="form-field-field_b8a4da8-0">Ayurvedic, Unani &amp; Siddha Medicines</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-1" name="form_fields[field_b8a4da8][]" type="checkbox" value="Herbal Products, Extracts &amp; Ingredients"/> <label for="form-field-field_b8a4da8-1">Herbal Products, Extracts &amp; Ingredients</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-2" name="form_fields[field_b8a4da8][]" type="checkbox" value="Natural &amp; Organic Products"/> <label for="form-field-field_b8a4da8-2">Natural &amp; Organic Products</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-3" name="form_fields[field_b8a4da8][]" type="checkbox" value="Agro, Dairy, Tea, &amp; Spices Products"/> <label for="form-field-field_b8a4da8-3">Agro, Dairy, Tea, &amp; Spices Products</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-4" name="form_fields[field_b8a4da8][]" type="checkbox" value="Honeybee, Coconut &amp; Banana Products"/> <label for="form-field-field_b8a4da8-4">Honeybee, Coconut &amp; Banana Products</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-5" name="form_fields[field_b8a4da8][]" type="checkbox" value="Sanitizers, Soaps, Gel, Rub &amp; Floor Cleaners"/> <label for="form-field-field_b8a4da8-5">Sanitizers, Soaps, Gel, Rub &amp; Floor Cleaners</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-6" name="form_fields[field_b8a4da8][]" type="checkbox" value="Yoga Mats, Apparels and Accessories"/> <label for="form-field-field_b8a4da8-6">Yoga Mats, Apparels and Accessories</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-7" name="form_fields[field_b8a4da8][]" type="checkbox" value="Meditation Products and Astro Product"/> <label for="form-field-field_b8a4da8-7">Meditation Products and Astro Product</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-8" name="form_fields[field_b8a4da8][]" type="checkbox" value="Medicine Manufacturing Machines"/> <label for="form-field-field_b8a4da8-8">Medicine Manufacturing Machines</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-9" name="form_fields[field_b8a4da8][]" type="checkbox" value="Health &amp; Wellness Supplements"/> <label for="form-field-field_b8a4da8-9">Health &amp; Wellness Supplements</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-10" name="form_fields[field_b8a4da8][]" type="checkbox" value="Physiotherapy Machines &amp; Equipment"/> <label for="form-field-field_b8a4da8-10">Physiotherapy Machines &amp; Equipment</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-11" name="form_fields[field_b8a4da8][]" type="checkbox" value="Medicine Packaging, Wrapping, Labelling"/> <label for="form-field-field_b8a4da8-11">Medicine Packaging, Wrapping, Labelling</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-12" name="form_fields[field_b8a4da8][]" type="checkbox" value="Khadi Clothes, Herbal and Organic Apparels"/> <label for="form-field-field_b8a4da8-12">Khadi Clothes, Herbal and Organic Apparels</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-13" name="form_fields[field_b8a4da8][]" type="checkbox" value="Jute, Bamboo, Coir &amp; Moonj Products"/> <label for="form-field-field_b8a4da8-13">Jute, Bamboo, Coir &amp; Moonj Products</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-14" name="form_fields[field_b8a4da8][]" type="checkbox" value="Fitness Equipment, Gadgets &amp; Accessories"/> <label for="form-field-field_b8a4da8-14">Fitness Equipment, Gadgets &amp; Accessories</label></span><span class="elementor-field-option"><input id="form-field-field_b8a4da8-15" name="form_fields[field_b8a4da8][]" type="checkbox" value="Acupressure, Acupuncture"/> <label for="form-field-field_b8a4da8-15">Acupressure, Acupuncture</label></span></div> </div>
<div class="elementor-field-type-upload elementor-field-group elementor-column elementor-field-group-field_bd85b0e elementor-col-100">
<label class="elementor-field-label" for="form-field-field_bd85b0e">
								Company Logo							</label>
<input class="elementor-field elementor-size-sm elementor-upload-field" id="form-field-field_bd85b0e" name="form_fields[field_bd85b0e]" type="file"/>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_818ec9f elementor-col-50">
<label class="elementor-field-label" for="form-field-field_818ec9f">
								Office Address 							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_818ec9f" name="form_fields[field_818ec9f]" placeholder="Office Address " size="1" type="text"/>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_ed50e5a elementor-col-50">
<label class="elementor-field-label" for="form-field-field_ed50e5a">
								City							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_ed50e5a" name="form_fields[field_ed50e5a]" placeholder="Your City" size="1" type="text"/>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_6ebe4ce elementor-col-50">
<label class="elementor-field-label" for="form-field-field_6ebe4ce">
								State							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_6ebe4ce" name="form_fields[field_6ebe4ce]" placeholder="Your State" size="1" type="text"/>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_e686a4c elementor-col-50">
<label class="elementor-field-label" for="form-field-field_e686a4c">
								Pin Code							</label>
<input class="elementor-field elementor-size-sm elementor-field-textual" id="form-field-field_e686a4c" name="form_fields[field_e686a4c]" placeholder="Pin Code" size="1" type="text"/>
</div>
...
<!-- ============ PRODUCT CATEGORIES ============ -->
<section class="ayv-section ayv-section-alt">
<div class="ayv-wrap">
<h2 class="ayv-heading">Product &amp; Exhibit Categories</h2>
<p class="ayv-heading-sub">Select the categories most relevant to your stall when filling the enquiry form above.</p>
<div class="ayv-cat-grid">
<div class="ayv-cat">Ayurvedic, Unani &amp; Siddha Medicines</div>
<div class="ayv-cat">Herbal Products, Extracts &amp; Ingredients</div>
<div class="ayv-cat">Natural &amp; Organic Products</div>
<div class="ayv-cat">Agro, Dairy, Tea &amp; Spice Products</div>
<div class="ayv-cat">Honey, Coconut &amp; Banana Products</div>
<div class="ayv-cat">Sanitizers, Soaps, Gels &amp; Cleaners</div>
<div class="ayv-cat">Yoga Mats, Apparel &amp; Accessories</div>
<div class="ayv-cat">Meditation &amp; Astro Products</div>
<div class="ayv-cat">Medicine Manufacturing Machines</div>
<div class="ayv-cat">Health &amp; Wellness Supplements</div>
<div class="ayv-cat">Physiotherapy Machines &amp; Equipment</div>
<div class="ayv-cat">Medicine Packaging &amp; Labelling</div>
<div class="ayv-cat">Khadi, Herbal &amp; Organic Apparel</div>
<div class="ayv-cat">Jute, Bamboo, Coir &amp; Moonj Products</div>
<div class="ayv-cat">Fitness Equipment &amp; Gadgets</div>
<div class="ayv-cat">Acupressure &amp; Acupuncture</div>
</div>
</div>
</section>
<!-- ============ WHY EXHIBIT ============ -->
<section class="ayv-section">
<div class="ayv-wrap">
<h2 class="ayv-heading">Why Exhibit?</h2>
<div class="ayv-cards">
<div class="ayv-card">
<div class="ayv-card-icon">①</div>
<h4>Brand Visibility</h4>
<p>Reach a highly targeted audience of Ayurveda professionals and practitioners.</p>
</div>
<div class="ayv-card">
<div class="ayv-card-icon">②</div>
<h4>B2B Networking</h4>
<p>Connect directly with distributors, hospitals and Ayurvedic institutions.</p>
</div>
<div class="ayv-card">
<div class="ayv-card-icon">③</div>
<h4>Product Launch</h4>
<p>Introduce new wellness, herbal and healthcare products to a ready market.</p>
</div>
<div class="ayv-card">
<div class="ayv-card-icon">④</div>
<h4>Business Growth</h4>
<p>Generate qualified enquiries, leads and long-term partnerships.</p>
</div>
</div>
</div>
</section>
<!-- ============ CTA / HOLISTIC WELLNESS BANNER ============ -->
<section class="ayv-cta">
<div class="ayv-wrap ayv-cta-inner">
<span class="ayv-tag ayv-tag-light">HOLISTIC WELLNESS</span>
<h2>Experience the Future of Ayurveda</h2>
<p>
        Connect with national experts, explore innovations, and unlock new
        opportunities at Ayurved Yashobhoomi 2026. Be part of a movement where
        ancient wisdom meets modern wellbeing.
      </p>
<a class="ayv-btn ayv-btn-light" href="#ayv-enquiry">Reserve Your Stall Today</a>
</div>
</section>
<!-- ============ CONTACT STRIP ============ -->
<section class="ayv-section ayv-contact-strip">
<div class="ayv-wrap ayv-contact-grid">
<div class="ayv-contact-block">
<h5>Exhibitor Enquiry</h5>
<p><a href="mailto:info@ayurvedamfoundation.com">info@ayurvedamfoundation.com</a></p>
<p><a href="mailto:founder@ayurvedamfoundation.org">founder@ayurvedamfoundation.org</a></p>
<p><a href="tel:+918318714809">+91 83187 14809</a></p>
</div>
<div class="ayv-contact-block">
<h5>Delegate Enquiry</h5>
<p><a href="mailto:info@ayurvedamfoundation.com">info@ayurvedamfoundation.com</a></p>
<p><a href="tel:+918318714809">+91 83187 14809</a></p>
</div>
<div class="ayv-contact-block">
<h5>Venue</h5>
<p>Shri Prem Nagar Ashram, Haridwar</p>
<p>23–24 December 2026</p>
</div>
</div>
</section>
</div>
