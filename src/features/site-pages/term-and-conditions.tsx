...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-640 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-640" />
      ...
      <link rel="stylesheet" id="elementor-post-640-css" href="/css/elementor-post-640.css" media="all" />
...
`
      ...
      <style id="style-inline-term-and-conditions-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-term-and-conditions-5" dangerouslySetInnerHTML={{
        __html: `
...
<div class="elementor elementor-640" data-elementor-id="640" data-elementor-post-type="page" data-elementor-type="wp-page">
<section class="elementor-section elementor-top-section elementor-element elementor-element-b495918 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="b495918" data-settings='{"background_background":"classic"}'>
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-95f60a2" data-e-type="column" data-element_type="column" data-id="95f60a2">
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-6f2da09 elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="6f2da09" data-widget_type="heading.default">
<div class="elementor-widget-container">
...
<section class="elementor-section elementor-top-section elementor-element elementor-element-da38efb elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="da38efb" data-settings='{"background_background":"classic"}'>
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-5c33ca6" data-e-type="column" data-element_type="column" data-id="5c33ca6">
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-aa1c31d elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="aa1c31d" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p data-pm-slice="1 1 []">Welcome to the official website of Ayurvedam Foundation. By accessing and using this website, you agree to comply with the following Terms and Conditions. If you do not agree with any part of these terms, please refrain from using this website.</p><p data-pm-slice="1 1 []"> </p><p><strong>Eligibility</strong> This website is intended for individuals and organizations interested in Ayurveda, including students, practitioners, researchers, and businesses. By using this platform, you confirm that you meet the eligibility criteria for participation in our activities and events.</p><p> </p><p><strong>Payment and Refund Policy</strong> All payments related to event registrations, memberships, and other services must be made through the authorized payment gateway provided on the website. Payments are non-refundable unless explicitly stated otherwise or in the case of event cancellation by the organizers.</p><p>If an event is canceled, refunds will be processed within 30 working days.</p><p> </p><p><strong>User Conduct</strong> Users of this website must adhere to ethical and respectful behavior when engaging with the platform and other users. Any form of misconduct, misrepresentation, or violation of policies may result in account suspension or removal from the event or service without a refund.</p><p>Businesses and exhibitors associated with Ayurvedam Foundation must ensure that their products and services comply with all applicable laws and regulations.</p><p> </p><p><strong>Intellectual Property</strong> All content, logos, materials, and intellectual property on this website are the exclusive property of Ayurvedam Foundation. Unauthorized use, reproduction, modification, or distribution of website materials, branding, or digital content is strictly prohibited and may result in legal action.</p><p><strong>Limitation of Liability</strong> Ayurvedam Foundation is not liable for any loss, damage, injury, or technical issues that may arise while accessing the website or participating in our events and programs.</p><p> </p><p><strong>Privacy Policy</strong> Personal information collected through this website will be used solely for the purpose of managing events, memberships, communications, and logistical support. We do not share personal data with third parties without explicit consent, except where required by law.</p><p> </p><p><strong>Amendments to Terms</strong> Ayurvedam Foundation reserves the right to update or modify these Terms and Conditions at any time without prior notice. Continued use of the website implies acceptance of the updated terms.</p> </div>
</div>
</div>
</div>
</div>
