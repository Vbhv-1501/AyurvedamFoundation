...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-86 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-86" />
      ...
      <link rel="stylesheet" id="elementor-post-86-css" href="/css/elementor-post-86.css" media="all" />
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=Eczar:wght@500;600;700;800&family=Jost:wght@300;400;500;600;700&family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500;9..144,600;9..144,700&family=Outfit:wght@300;400;500;600;700&display=swap" media="print" />
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=Eczar:wght@500;600;700;800&family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500;9..144,600;9..144,700&family=Outfit:wght@300;400;500;600;700&display=swap" media="all" />
...
`
      ...
      <style id="style-inline-exhibitors-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-exhibitors-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-exhibitors-7" dangerouslySetInnerHTML={{
        __html: `
  #ayv-root {
    --ivory: #FBF6EC;
    --card: #FFFDF8;
  ...
  #ayv-root h1, #ayv-root h2, #ayv-root h3, #ayv-root h4, #ayv-root h5, #ayv-root h6 { font-family: 'Cormorant Garamond', serif; margin: 0; line-height: 1.2; font-weight: 700; }
  #ayv-root .ayv-wrap { max-width: 1180px; margin: 0 auto; padding: 0 28px; width: 100%; }
  #ayv-root section { position: relative; padding: 90px 0; }
  ...
  #ayv-root .ayv-reveal { opacity: 1; transform: translateY(0); transition: opacity .9s cubic-bezier(.2,.7,.2,1), transform .9s cubic-bezier(.2,.7,.2,1); will-change: opacity, transform; }
  ...
  .profile-hero .ayv-wrap { position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; }
  .profile-hero h1 { font-size: clamp(38px, 6vw, 60px); color: #fff; margin-bottom: 16px; letter-spacing: 0.02em; }
  .profile-hero .ayw-crumb { font-size: 14px; color: #EAE3DC; font-family: 'Outfit', sans-serif; letter-spacing: 0.05em; text-transform: uppercase; opacity: 0.8; }
  .profile-hero .ayw-crumb span { margin: 0 8px; opacity: 0.5; color: var(--gold); }

  /* ---------- INTRO SECTION ---------- */
  .profile-intro { text-align: center; max-width: 800px; margin: 0 auto; padding-bottom: 40px; }
  .profile-intro h2 { font-size: clamp(32px, 4vw, 42px); color: var(--maroon); margin-bottom: 20px; }
  .profile-intro p { font-size: 17px; line-height: 1.7; color: #473C34; }

  /* ---------- BRAND LOGOS (VISIBLE BOXED GRID) ---------- */
  .brand-logo-section { background: var(--card); padding: 80px 0; border-top: 1px solid #ECE2CC; border-bottom: 1px solid #ECE2CC; }
  .brand-logo-grid { display: grid; grid-template-columns: repeat(6, 1fr); gap: 20px; }
  .brand-item { 
    background: #fff; border: 1px solid #ECE2CC; border-radius: 12px; height: 110px; 
    display: flex; align-items: center; justify-content: center; padding: 20px; 
    box-shadow: 0 4px 15px rgba(0,0,0,0.03); transition: all 0.3s ease; 
  }
  .brand-item:hover { transform: translateY(-5px); box-shadow: 0 12px 24px rgba(110,26,61,0.1); border-color: var(--gold); }
  .brand-item img { max-width: 100%; max-height: 100%; object-fit: contain; }

  /* ---------- EXHIBITOR CATEGORIES GRID ---------- */
  .cat-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-top: 20px; }
  .profile-card {
    background: #fff; border: 1px solid #ECE2CC; border-radius: 16px; padding: 36px 24px; text-align: left;
    box-shadow: 0 10px 30px -15px rgba(0,0,0,0.08); transition: all 0.3s ease; position: relative; overflow: hidden;
  }
  .profile-card::before {
    content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 4px; background: var(--gold);
    transform: scaleX(0); transform-origin: left; transition: transform 0.4s ease;
  }
  .profile-card:hover { transform: translateY(-8px); box-shadow: 0 20px 40px -15px rgba(110,26,61,0.15); border-color: transparent; }
  .profile-card:hover::before { transform: scaleX(1); }
  
  .profile-card .icon-wrapper {
    width: 64px; height: 64px; background: linear-gradient(135deg, rgba(156,34,71,0.05), rgba(156,34,71,0.15));
    color: var(--maroon); border-radius: 50%; display: flex; align-items: center; justify-content: center;
    font-size: 28px; margin-bottom: 20px; border: 1px solid rgba(156,34,71,0.1);
  }
  .profile-card h4 { font-size: 22px; color: var(--ink); margin-bottom: 12px; }
  .profile-card p { font-size: 15px; color: #564A40; line-height: 1.6; margin: 0; }

  /* ---------- VISITOR PROFILE (DARK SECTION) ---------- */
  .visitor-profile { background: linear-gradient(180deg, var(--forest-deep), var(--forest)); color: #fff; position: relative; }
  .visitor-profile::before {
    content: ''; position: absolute; top: 0; right: 0; width: 50%; height: 100%;
    background: radial-gradient(circle at 100% 50%, rgba(201,146,78,0.15) 0%, transparent 60%); pointer-events: none;
  }
  .visitor-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center; position: relative; z-index: 2;}
  .visitor-text h2 { font-size: clamp(32px, 4vw, 42px); color: #fff; margin-bottom: 20px; }
  .visitor-text p { font-size: 17px; line-height: 1.7; color: #EAE3DC; margin-bottom: 30px; }
  
  .visitor-list { list-style: none; padding: 0; margin: 0; display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
  .visitor-list li { display: flex; align-items: flex-start; gap: 12px; font-family: 'Outfit', sans-serif; font-size: 16px; color: #f5dfe7; font-weight: 400; line-height: 1.5;}
  .visitor-list li i { color: var(--gold); font-size: 18px; margin-top: 2px; }

  /* Visitor Stats Layout */
  .visitor-stats-container { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 24px; padding: 40px; backdrop-filter: blur(10px); }
  .v-stat { margin-bottom: 24px; }
  .v-stat:last-child { margin-bottom: 0; }
  .v-stat-header { display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 10px; }
  .v-stat-title { font-family: 'Outfit', sans-serif; font-size: 16px; color: #fff; font-weight: 500; letter-spacing: 0.02em; }
  .v-stat-num { font-family: 'Fraunces', serif; font-size: 24px; color: var(--gold); font-weight: 700; line-height: 1; }
  .v-bar-bg { width: 100%; height: 6px; background: rgba(255,255,255,0.1); border-radius: 10px; overflow: hidden; }
  .v-bar-fill { height: 100%; background: linear-gradient(90deg, var(--terracotta), var(--gold)); border-radius: 10px; }

  /* ---------- CTA BOTTOM ---------- */
  .bottom-cta-grid { display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 40px; align-items: center; background: #fff; border: 1px solid #ECE2CC; border-radius: 24px; padding: 50px; box-shadow: 0 16px 34px -20px rgba(0,0,0,.15); margin-top: -40px; position: relative; z-index: 10;}
  .cta-text h2 { font-size: 36px; color: var(--maroon); margin-bottom: 16px; }
  .cta-text p { font-size: 16.5px; color: #473C34; margin: 0; line-height: 1.6;}
  .cta-action { background: var(--ivory); border: 1px dashed var(--terracotta); border-radius: 16px; padding: 30px; text-align: center; }
  .cta-action .label { display: block; font-family: 'Outfit', sans-serif; font-size: 12px; letter-spacing: 0.15em; text-transform: uppercase; color: var(--maroon); margin-bottom: 10px; font-weight: 600;}
  .cta-action .phone { display: block; font-family: 'Fraunces', serif; font-size: 32px; color: var(--ink); text-decoration: none; margin-bottom: 24px; transition: color 0.3s;}
  .cta-action .phone:hover { color: var(--terracotta); }
  .cta-action .ayv-btn { width: 100%; }
  ...
  @media (max-width: 880px) {
    .visitor-grid { grid-template-columns: 1fr; gap: 40px; }
    .bottom-cta-grid { grid-template-columns: 1fr; text-align: center; padding: 40px 30px;}
    .brand-logo-grid { grid-template-columns: repeat(3, 1fr); }
  }
  @media (max-width: 600px) {
    .profile-hero { padding: 80px 0 60px; }
    .profile-hero h1 { font-size: clamp(32px, 8vw, 42px); }
    .cat-grid { grid-template-columns: 1fr; }
    .visitor-list { grid-template-columns: 1fr; }
    .visitor-stats-container { padding: 30px 20px; }
    .brand-logo-grid { grid-template-columns: repeat(2, 1fr); gap: 15px; }
    .brand-item { height: 90px; padding: 15px; }
  }
`
      }} />
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-86 current_page_item menu-item-14329"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/exhibitors">Exhibitor Profile</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-86 current_page_item menu-item-14329"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/exhibitors" tabindex="-1">Exhibitor Profile</a></li>
...
<div class="elementor elementor-86" data-elementor-id="86" data-elementor-post-type="page" data-elementor-type="wp-page">
<div class="elementor-element elementor-element-045a0a3 e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="045a0a3">
<div class="elementor-element elementor-element-4e74541 elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="4e74541" data-widget_type="html.default">
<div class="elementor-widget-container">
<!-- ================================================================
  AYURVED YASHOBHOOMI 2026 — Exhibitor Profile Page
================================================================= -->
...
<p class="ayw-crumb">Home <span>•</span> Exhibitors <span>•</span> Exhibitor Profile</p>
</div>
</section>
<!-- ============ INTRO & CATEGORIES ============ -->
<section>
<div class="ayv-wrap">
<div class="profile-intro ayv-reveal">
<span class="ayv-eyebrow" style="justify-content: center;">Who Should Exhibit</span>
<h2>Showcase Your Brand to the World of AYUSH</h2>
<p>Ayurved Yashobhoomi 2026 is the ultimate platform for brands across the Ayurveda, holistic wellness, and organic sectors to present their products and services to a highly targeted, professional audience.</p>
</div>
<div class="cat-grid">
<!-- Card 1 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-mortar-pestle"></i></div>
<h4>Ayurvedic Medicine</h4>
<p>Manufacturers and distributors of classical and proprietary Ayurvedic medicines, bhasmas, and herbal formulations.</p>
</div>
<!-- Card 2 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-leaf"></i></div>
<h4>Herbal &amp; Organic Cosmetics</h4>
<p>Brands specializing in natural skincare, haircare, essential oils, and organic beauty products rooted in Ayurveda.</p>
</div>
<!-- Card 3 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-spa"></i></div>
<h4>Panchakarma Equipment</h4>
<p>Manufacturers of Droni tables, Swedana yantras, Shirodhara stands, and essential clinic setup machinery.</p>
</div>
<!-- Card 4 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-capsules"></i></div>
<h4>Nutraceuticals &amp; Diet</h4>
<p>Providers of Ayurvedic health supplements, immunity boosters, medicinal teas, and specialized dietary foods.</p>
</div>
<!-- Card 5 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-hospital"></i></div>
<h4>Hospitals &amp; Wellness Centres</h4>
<p>Ayurvedic hospitals, holistic wellness retreats, and healing centers offering traditional therapies.</p>
</div>
<!-- Card 6 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-seedling"></i></div>
<h4>Organic Food &amp; Agri</h4>
<p>Suppliers of certified organic foods, raw herbs, medicinal plant cultivators, and sustainable agriculture tech.</p>
</div>
<!-- Card 7 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-laptop-medical"></i></div>
<h4>AYUSH Tech &amp; Software</h4>
<p>Startups and companies providing clinic management software, Nadi Tarangini devices, and health-tech solutions.</p>
</div>
<!-- Card 8 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-book-medical"></i></div>
<h4>Publishers &amp; Institutions</h4>
<p>Medical book publishers, research journals, and educational institutions offering degrees in Ayurveda and Yoga.</p>
</div>
<!-- Card 9 -->
<div class="profile-card ayv-reveal">
<div class="icon-wrapper"><i class="fas fa-flask"></i></div>
<h4>Lab &amp; Testing Facilities</h4>
<p>Laboratories providing quality testing, standardization, and certification services for herbal formulations.</p>
</div>
</div>
</div>
</section>
<!-- ============ OFFICIAL BRAND LOGOS (FULL COLOR GRID) ============ -->
<section class="brand-logo-section">
<div class="ayv-wrap">
<div class="ayv-reveal" style="text-align: center; margin-bottom: 30px;">
<h3 style="font-family: 'Outfit', sans-serif; font-size: 14px; color: var(--terracotta); text-transform: uppercase; letter-spacing: 0.15em; font-weight: 600;">Join Over 150+ Top Ayurveda Brands</h3>
</div>
<div class="brand-logo-grid ayv-reveal">
<!-- Dabur -->
<div class="brand-item" title="Dabur">
<img alt="Dabur" decoding="async" loading="lazy" src="/uploads/2026/06/dabur-logo-png_seeklogo-247892.png"/>
</div>
<!-- Himalaya Wellness -->
<div class="brand-item" title="Himalaya Wellness">
<img alt="Himalaya Wellness" decoding="async" loading="lazy" src="/uploads/2026/06/logo-aboutus.avif"/>
</div>
<!-- Patanjali -->
<div class="brand-item" title="Patanjali Ayurved">
<img alt="Patanjali" decoding="async" loading="lazy" src="/uploads/2026/06/images-3.png"/>
</div>
<!-- Baidyanath -->
<div class="brand-item" title="Baidyanath">
<img alt="Baidyanath" decoding="async" loading="lazy" src="https://www.baidyanath.co.in/images/logo.png"/>
</div>
<!-- Zandu -->
<div class="brand-item" title="Zandu Care">
<img alt="Zandu" decoding="async" loading="lazy" src="/uploads/2026/06/Zandu_Realty.png"/>
</div>
<!-- Sri Sri Tattva -->
<div class="brand-item" title="Sri Sri Tattva">
<img alt="Sri Sri Tattva" decoding="async" loading="lazy" src="/uploads/2026/06/Sri_Sri_Tattva_Logo_Updated_2018.webp" style="max-height: 50px;"/>
</div>
</div>
</div>
</section>
...
<div class="visitor-text ayv-reveal">
<span class="ayv-eyebrow" style="color: var(--gold); border-color: var(--gold);">Who Will You Meet?</span>
<h2>A Highly Targeted Professional Audience</h2>
<p>Exhibiting at Ayurved Yashobhoomi guarantees direct interaction with key decision-makers, bulk buyers, and practitioners in the Indian healthcare system. Connect with <strong>20,000+ expected visitors</strong> over two days.</p>
<ul class="visitor-list">
<li><i class="fas fa-check-circle"></i> Ayurveda Doctors &amp; Vaidyas</li>
<li><i class="fas fa-check-circle"></i> B2B Distributors &amp; Wholesalers</li>
<li><i class="fas fa-check-circle"></i> Pharmacy Retailers</li>
<li><i class="fas fa-check-circle"></i> Hospital &amp; Clinic Owners</li>
<li><i class="fas fa-check-circle"></i> AYUSH Ministry Officials</li>
<li><i class="fas fa-check-circle"></i> Researchers &amp; Academicians</li>
<li><i class="fas fa-check-circle"></i> Wellness &amp; Spa Managers</li>
<li><i class="fas fa-check-circle"></i> Health &amp; Lifestyle Enthusiasts</li>
</ul>
</div>
<div class="visitor-stats-container ayv-reveal">
<div class="v-stat">
<div class="v-stat-header">
<span class="v-stat-title">Doctors &amp; Practitioners</span>
<span class="v-stat-num">45%</span>
</div>
<div class="v-bar-bg"><div class="v-bar-fill" style="width: 45%;"></div></div>
</div>
<div class="v-stat">
<div class="v-stat-header">
<span class="v-stat-title">General Visitors &amp; Patients</span>
<span class="v-stat-num">30%</span>
</div>
<div class="v-bar-bg"><div class="v-bar-fill" style="width: 30%;"></div></div>
</div>
<div class="v-stat">
<div class="v-stat-header">
<span class="v-stat-title">B2B Distributors &amp; Retailers</span>
<span class="v-stat-num">15%</span>
</div>
<div class="v-bar-bg"><div class="v-bar-fill" style="width: 15%;"></div></div>
</div>
<div class="v-stat">
<div class="v-stat-header">
<span class="v-stat-title">Academicians &amp; Students</span>
<span class="v-stat-num">10%</span>
</div>
<div class="v-bar-bg"><div class="v-bar-fill" style="width: 10%;"></div></div>
</div>
</div>
</div>
</div>
...
<!-- ============ BOTTOM CTA ============ -->
<section style="background: var(--ivory); padding-bottom: 100px;">
<div class="ayv-wrap">
<div class="bottom-cta-grid ayv-reveal">
<div class="cta-text">
<span class="ayv-eyebrow">Stall Booking</span>
<h2>Secure Your Prime Location</h2>
<p>Don't miss the opportunity to position your brand at India's most practical and engaging Ayurveda conference. Exhibition spaces are allocated on a first-come, first-served basis.</p>
</div>
<div class="cta-action">
<span class="label">Call For Bookings</span>
<a class="phone" href="tel:+918318714809">+91 83187 14809</a>
<a class="ayv-btn" href="/contact-us">Request Floor Plan</a>
</div>
</div>
</div>
</section>
