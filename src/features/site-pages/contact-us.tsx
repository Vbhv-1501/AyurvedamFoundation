...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-94 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-94" />
      ...
      <link rel="stylesheet" id="widget-google_maps-css" href="/css/elementor-widget-google_maps.css" media="all" />
      <link rel="stylesheet" id="elementor-post-94-css" href="/css/elementor-post-94.css" media="all" />
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=Jost:wght@300;400;500;600;700&family=Outfit:wght@300;400;500;600;700&display=swap" media="all" />
...
`
      ...
      <style id="style-inline-contact-us-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-contact-us-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-contact-us-7" dangerouslySetInnerHTML={{
        __html: `
  #ayv-contact-modern {
    --ivory: #FBF6EC;
    --card: #FFFDF8;
  ...
  #ayv-contact-modern * { box-sizing: border-box; }
  #ayv-contact-modern .ay-wrap { max-width: 1200px; margin: 0 auto; padding: 0 24px; }
  
  /* --- Section Header --- */
  .ay-header { text-align: center; margin-bottom: 60px; }
  .ay-eyebrow {
  ...
  .ay-eyebrow::before, .ay-eyebrow::after { content: ""; width: 30px; height: 1px; background: var(--terracotta); display: inline-block; }
  .ay-header h2 {
    font-family: 'Cormorant Garamond', serif; font-size: clamp(36px, 5vw, 50px);
    color: var(--maroon); margin: 0; font-weight: 700; line-height: 1.1;
  }
  .ay-header p {
    font-size: 17px; color: #564A40; max-width: 600px; margin: 16px auto 0; line-height: 1.6;
  }
  ...
  .ay-card {
    ...
    border: 1px solid #ECE2CC; text-align: center; position: relative; z-index: 1;
    box-shadow: 0 10px 30px -15px rgba(0,0,0,0.06); transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1);
  }
  .ay-card::before {
    content: ''; position: absolute; inset: 0; border-radius: 24px;
    background: linear-gradient(135deg, var(--forest), var(--maroon));
    z-index: -1; opacity: 0; transition: opacity 0.4s ease;
  }
  
  .ay-card:hover { transform: translateY(-10px); box-shadow: 0 20px 40px -10px rgba(110,26,61,0.25); border-color: transparent;}
  .ay-card:hover::before { opacity: 1; }

  /* --- Card Icons --- */
  .ay-icon-wrap {
    width: 76px; height: 76px; margin: 0 auto 24px; border-radius: 50%;
    background: linear-gradient(135deg, rgba(156,34,71,0.05), rgba(156,34,71,0.15));
    border: 1px solid rgba(156,34,71,0.1); display: flex; align-items: center; justify-content: center;
    font-size: 30px; color: var(--maroon); transition: all 0.4s ease;
  }
  .ay-card:hover .ay-icon-wrap {
    background: #ffffff; border-color: #ffffff; color: var(--maroon); transform: scale(1.1);
  ...
  .ay-card h3 {
    ...
    color: var(--ink); margin: 0 0 20px 0; transition: color 0.4s ease;
  }
  .ay-card:hover h3 { color: var(--gold); }

  .ay-info-group { margin-bottom: 20px; }
  .ay-info-group:last-child { margin-bottom: 0; }
  
  .ay-label {
    display: block; font-family: 'Outfit', sans-serif; font-size: 11px; font-weight: 600;
    text-transform: uppercase; letter-spacing: 0.1em; color: var(--terracotta); margin-bottom: 6px;
    transition: color 0.4s ease;
  }
  .ay-card:hover .ay-label { color: #f5dfe7; }

  .ay-text {
    font-size: 15.5px; color: #473C34; line-height: 1.6; margin: 0; transition: color 0.4s ease;
  }
  .ay-card:hover .ay-text { color: #ffffff; }

  .ay-link {
    display: block; font-family: 'Outfit', sans-serif; font-size: 18px; font-weight: 500;
    color: var(--ink); text-decoration: none; margin-bottom: 8px; transition: color 0.4s ease;
  }
  .ay-link:last-child { margin-bottom: 0; }
  .ay-link:hover { color: var(--terracotta); text-decoration: underline;}
  .ay-card:hover .ay-link { color: #ffffff; }
  .ay-card:hover .ay-link:hover { color: var(--gold); }

  /* --- Divider Line inside Card --- */
  .ay-divider {
    width: 40px; height: 2px; background: #ECE2CC; margin: 20px auto; transition: background 0.4s ease;
  }
  .ay-card:hover .ay-divider { background: rgba(255,255,255,0.2); }

  /* --- Social Icons --- */
  .ay-socials { display: flex; justify-content: center; gap: 12px; margin-top: 15px; }
  .ay-social-btn {
    width: 40px; height: 40px; border-radius: 50%; background: #FBF6EC; color: var(--maroon);
    display: flex; align-items: center; justify-content: center; font-size: 16px;
    text-decoration: none; transition: all 0.3s ease;
  }
  .ay-card:hover .ay-social-btn { background: rgba(255,255,255,0.1); color: #fff; }
  .ay-card:hover .ay-social-btn:hover { background: var(--gold); color: var(--forest-deep); transform: translateY(-3px); }

  /* --- Responsive Breakpoints --- */
  @media (max-width: 1024px) {
    .ay-contact-grid { gap: 20px; }
    .ay-card { padding: 30px 20px; }
  }
  @media (max-width: 880px) {
    .ay-contact-grid { grid-template-columns: 1fr; max-width: 500px; margin: 0 auto; }
  }
  @media (max-width: 600px) {
    #ayv-contact-modern { padding: 70px 0; }
    .ay-header { margin-bottom: 40px; }
    .ay-header h2 { font-size: 32px; }
  }
`
      }} />
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-94 current_page_item menu-item-112"><a aria-current="page" class="elementor-item elementor-item-active" href="/contact-us/">CONTACT US</a></li>
</ul> </nav>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-94 current_page_item menu-item-112"><a aria-current="page" class="elementor-item elementor-item-active" href="/contact-us/" tabindex="-1">CONTACT US</a></li>
</ul> </nav>
</div>
</div>
</div>
...
<div class="elementor elementor-94" data-elementor-id="94" data-elementor-post-type="page" data-elementor-type="wp-page">
<div class="elementor-element elementor-element-ea7c7c0 e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="ea7c7c0">
<div class="elementor-element elementor-element-cae3a34 elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="cae3a34" data-widget_type="html.default">
<div class="elementor-widget-container">
<!-- ================================================================
  AYURVED YASHOBHOOMI 2026 — Modern Contact Details Section
================================================================= -->
...
<div id="ayv-contact-modern">
<div class="ay-wrap">
<div class="ay-header">
<span class="ay-eyebrow">Get In Touch</span>
<h2>We Are Here To Assist You</h2>
<p>Whether you're seeking information about delegate registration, exhibiting opportunities, or simply want to connect with our team, feel free to reach out.</p>
</div>
<div class="ay-contact-grid">
<!-- CARD 1: ADDRESS & VENUE -->
<div class="ay-card">
<div class="ay-icon-wrap"><i class="fas fa-map-marked-alt"></i></div>
<h3>Locations</h3>
<div class="ay-info-group">
<span class="ay-label">Head Office</span>
<p class="ay-text">SH8/3A/7K-1 Ayodhya Dham Colony, Luxmanpur, Olympian Lalit Upadhyay Gate, Shivpur Bypass Road, Varanasi - 221003</p>
</div>
<div class="ay-divider"></div>
<div class="ay-info-group">
<span class="ay-label">Event Venue</span>
<p class="ay-text">Shri Prem Nagar Ashram, Haridwar<br/><strong>(23–24 December 2026)</strong></p>
</div>
</div>
<!-- CARD 2: PHONE NUMBERS -->
<div class="ay-card">
<div class="ay-icon-wrap"><i class="fas fa-phone-volume"></i></div>
<h3>Call Us</h3>
<div class="ay-info-group">
<span class="ay-label">General Enquiry</span>
<a class="ay-link" href="tel:+916391053105">+91 63910 53105</a>
</div>
<div class="ay-info-group" style="margin-top: 24px;">
<span class="ay-label">Exhibitor Enquiry</span>
<a class="ay-link" href="tel:+918318714809">+91 83187 14809</a>
</div>
<div class="ay-info-group" style="margin-top: 24px;">
<span class="ay-label">Delegate Assistance</span>
<a class="ay-link" href="tel:+919140013151">+91 91400 13151</a>
</div>
</div>
<!-- CARD 3: EMAILS & SOCIAL -->
<div class="ay-card">
<div class="ay-icon-wrap"><i class="fas fa-envelope-open-text"></i></div>
<h3>Email &amp; Connect</h3>
<div class="ay-info-group">
<span class="ay-label">General Information</span>
<a class="ay-link" href="mailto:info@ayurvedamfoundation.org" style="font-size: 16px;">info@ayurvedamfoundation.org</a>
</div>
<div class="ay-info-group" style="margin-top: 20px;">
<span class="ay-label">Exhibitor Support</span>
<a class="ay-link" href="mailto:expo@ayurvedamfoundation.org" style="font-size: 16px;">expo@ayurvedamfoundation.org</a>
</div>
<div class="ay-info-group" style="margin-top: 20px;">
<span class="ay-label">Abstract Submissions</span>
<a class="ay-link" href="mailto:Abstract.ayurved@gmail.com" style="font-size: 16px;">Abstract.ayurved@gmail.com</a>
</div>
<div class="ay-divider"></div>
<div class="ay-socials">
<a aria-label="Facebook" class="ay-social-btn" href="https://www.facebook.com/ayurvedamfoundation" target="_blank"><i class="fab fa-facebook-f"></i></a>
<a aria-label="YouTube" class="ay-social-btn" href="https://www.youtube.com/@AyurvedamFoundation" target="_blank"><i class="fab fa-youtube"></i></a>
<a aria-label="Instagram" class="ay-social-btn" href="https://www.instagram.com/AyurvedamFoundation" target="_blank"><i class="fab fa-instagram"></i></a>
</div>
</div>
</div>
</div>
...
<section class="elementor-section elementor-top-section elementor-element elementor-element-15f5fa74 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="15f5fa74">
<div class="elementor-container elementor-column-gap-no">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-5594f82e" data-e-type="column" data-element_type="column" data-id="5594f82e">
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-5d338fbd elementor-widget elementor-widget-google_maps" data-e-type="widget" data-element_type="widget" data-id="5d338fbd" data-widget_type="google_maps.default">
<div class="elementor-widget-container">
<div class="elementor-custom-embed">
<iframe aria-label="SH8/3A/7K-1 Ayodhya Dham Colony, Luxmanpur, Olympian Lalit Upadhyay Gate, Shivpur Bypass Road, Varanasi - 221003" loading="lazy" src="https://maps.google.com/maps?q=SH8%2F3A%2F7K-1%20Ayodhya%20Dham%20Colony%2C%20Luxmanpur%2C%20Olympian%20Lalit%20Upadhyay%20Gate%2C%20Shivpur%20Bypass%20Road%2C%20Varanasi%20-%20221003&amp;t=m&amp;z=11&amp;output=embed&amp;iwloc=near" title="SH8/3A/7K-1 Ayodhya Dham Colony, Luxmanpur, Olympian Lalit Upadhyay Gate, Shivpur Bypass Road, Varanasi - 221003"></iframe>
</div>
</div>
</div>
</div>
