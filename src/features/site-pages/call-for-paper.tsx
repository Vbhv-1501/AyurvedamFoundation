...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-84 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-84" />
...
`
      ...
      <style id="style-inline-call-for-paper-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-call-for-paper-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-call-for-paper-7" dangerouslySetInnerHTML={{
        __html: `
  #ayv-root {
    --ivory: #FBF6EC;
    --card: #FFFDF8;
  ...
  #ayv-root h1, #ayv-root h2, #ayv-root h3, #ayv-root h4 { font-family: 'Cormorant Garamond', serif; margin: 0; line-height: 1.15; font-weight: 700; }
  #ayv-root .ayv-wrap { max-width: 1180px; margin: 0 auto; padding: 0 28px; width: 100%; }
  #ayv-root section { position: relative; padding: 80px 0; }
  ...
  #ayv-root .ayv-btn {
    ...
    background: linear-gradient(135deg, #6E1A3D, #C2185B); color: #fff !important; font-weight: 600; font-size: 16px; letter-spacing: .02em;
    padding: 18px 36px; border-radius: 50px; text-decoration: none; border: none; cursor: pointer;
    box-shadow: 0 10px 25px rgba(194, 24, 91, 0.3); transition: all .3s ease; text-transform: uppercase; font-family: 'Jost', sans-serif;
  }
  #ayv-root .ayv-btn:hover { transform: translateY(-4px); box-shadow: 0 15px 35px rgba(194, 24, 91, 0.5); color: #fff; }
  #ayv-root .ayv-btn.outline { background: transparent; border: 2px solid var(--maroon); color: var(--maroon) !important; box-shadow: none; }
  #ayv-root .ayv-btn.outline:hover { background: var(--maroon); color: #fff !important; }

  /* ---------- HERO ---------- */
  .abstract-hero {
    background: radial-gradient(circle at 80% 0%, rgba(201,146,78,0.15) 0%, transparent 40%), linear-gradient(135deg, var(--forest), var(--forest-deep));
    color: #fff; padding: 100px 0 80px; position: relative; overflow: hidden; text-align: center;
  }
  .abstract-hero::after {
    content: ''; position: absolute; inset: 0; background: url('data:image/svg+xml;utf8,<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="2" cy="2" r="1" fill="rgba(255,255,255,0.05')"/></svg>'); z-index: 1;
  }
  .abstract-hero .ayv-wrap { position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; }
  .abstract-hero .ayv-eyebrow { color: var(--gold); }
  .abstract-hero .ayv-eyebrow::before { background: var(--gold); }
  .abstract-hero h1 { font-size: clamp(38px, 6vw, 64px); color: #fff; margin-bottom: 24px; max-width: 800px; }
  .abstract-hero p { font-size: 18px; line-height: 1.6; color: #EAE3DC; max-width: 650px; margin-bottom: 40px; }

  /* ---------- DATES GRID ---------- */
  .dates-section { margin-top: -40px; position: relative; z-index: 10; padding: 0 !important; }
  .dates-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; }
  .date-card {
    background: var(--card); border: 1px solid #ECE2CC; border-radius: 16px; padding: 30px 24px;
    box-shadow: 0 16px 34px -20px rgba(0,0,0,.15); text-align: center; transition: transform 0.3s;
  }
  .date-card:hover { transform: translateY(-5px); box-shadow: 0 20px 40px -20px rgba(0,0,0,.25); }
  .date-card .icon { width: 50px; height: 50px; background: rgba(156,34,71,0.08); color: var(--maroon); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 20px; margin: 0 auto 16px; }
  .date-card h4 { font-size: 22px; color: var(--maroon); margin-bottom: 8px; }
  .date-card p { font-size: 15px; color: #564A40; margin: 0; font-weight: 500;}
  .date-card .tag { display: inline-block; background: var(--terracotta); color: #fff; font-size: 11px; font-weight: bold; padding: 4px 10px; border-radius: 20px; margin-top: 12px; letter-spacing: 0.05em; text-transform: uppercase; }

  /* ---------- GUIDELINES ---------- */
  .guidelines-wrap { display: grid; grid-template-columns: 1fr; gap: 30px; max-width: 900px; margin: 0 auto; }
  .guideline-box {
    background: #fff; border: 1px solid #ECE2CC; border-radius: 20px; padding: 40px; position: relative;
    box-shadow: 0 10px 30px -15px rgba(0,0,0,0.1);
  }
  .guideline-box .step-num {
    position: absolute; top: -20px; left: 40px; width: 44px; height: 44px; background: var(--maroon); color: #fff;
    border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif;
    font-size: 22px; font-weight: bold; border: 4px solid var(--ivory);
  }
  .guideline-box h3 { font-size: 24px; color: var(--ink); margin-bottom: 16px; border-bottom: 1px solid #ECE2CC; padding-bottom: 12px; }
  .guideline-box ul { list-style: none; padding: 0; margin: 0; }
  .guideline-box li { display: flex; align-items: flex-start; gap: 12px; font-size: 16px; color: #473C34; margin-bottom: 12px; line-height: 1.6; }
  .guideline-box li i { color: var(--gold); font-size: 14px; margin-top: 6px; }

  /* ---------- THEMES GRID ---------- */
  .theme-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-top: 40px; }
  .theme-card {
    background: var(--card); border: 1px solid #ECE2CC; border-radius: 12px; padding: 24px; transition: all 0.3s;
    border-top: 4px solid var(--gold);
  }
  .theme-card:hover { transform: translateY(-4px); box-shadow: 0 15px 30px -15px rgba(0,0,0,0.15); border-top-color: var(--maroon); }
  .theme-card h4 { font-size: 19px; color: var(--ink); margin-bottom: 10px; }
  .theme-card p { font-size: 14.5px; color: #564A40; line-height: 1.5; margin: 0; }

  /* ---------- SUBMISSION FORM ---------- */
  .ayv-form-wrapper {
    background: var(--card); border: 1px solid #ECE2CC; border-radius: 24px; padding: 50px; 
    box-shadow: 0 16px 34px -20px rgba(0,0,0,.15); max-width: 900px; margin: 0 auto;
  }
  .ayv-form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
  .ayv-form-group { display: flex; flex-direction: column; gap: 8px; text-align: left; }
  .ayv-form-group.full-width { grid-column: 1 / -1; }
  .ayv-form-label { font-size: 14.5px; font-weight: 600; color: var(--maroon); text-transform: uppercase; letter-spacing: 0.05em; }
  .ayv-form-control {
    font-family: 'Outfit', sans-serif; font-size: 16px; padding: 16px; border: 1px solid #ECE2CC; 
    border-radius: 12px; background: #fff; color: var(--ink); transition: all 0.3s ease; width: 100%;
  }
  .ayv-form-control::placeholder { color: #aaa; }
  .ayv-form-control:focus { border-color: var(--maroon); box-shadow: 0 0 0 4px rgba(122,27,61,0.1); outline: none; }
  .ayv-file-upload {
    border: 2px dashed #ECE2CC; padding: 40px 20px; text-align: center; border-radius: 12px; 
    background: #fafafa; cursor: pointer; transition: all 0.3s ease;
  }
  .ayv-file-upload:hover { border-color: var(--maroon); background: #fff5f8; }
  .ayv-submit-btn { width: 100%; margin-top: 10px; font-size: 18px !important; padding: 22px !important; border-radius: 50px; }
  ...
  @media (max-width: 880px) {
    ...
    .dates-section { margin-top: 40px; }
    .theme-grid { grid-template-columns: repeat(2, 1fr); }
  }
  @media (max-width: 700px) {
    .abstract-hero { padding: 80px 0 60px; }
    .abstract-hero h1 { font-size: clamp(32px, 8vw, 42px); }
    .guideline-box { padding: 30px 20px; margin-bottom: 10px;}
    .guideline-box .step-num { left: 20px; }
    .theme-grid { grid-template-columns: 1fr; }
    #ayv-root .ayv-btn { width: 100%; text-align: center; padding: 16px 20px; font-size: 15px;}
    
    .ayv-form-wrapper { padding: 30px 20px; }
    .ayv-form-grid { grid-template-columns: 1fr; }
  }
  
  
  
  /* ==========================================
   Elementor Shortcode Form Fix
   ========================================== */

.ayv-form-wrapper .elementor{
    width:100%;
}

.ayv-form-wrapper .elementor-widget-form{
    width:100%;
}

.ayv-form-wrapper .elementor-widget-container{
    padding:0 !important;
    margin:0 !important;
...
.ayv-form-wrapper form{
    width:100%;
}

.ayv-form-wrapper .elementor-form-fields-wrapper{
    display:flex;
    flex-wrap:wrap;
    gap:20px;
}
...
.ayv-form-wrapper .elementor-col-50{
    width:calc(50% - 10px) !important;
}

.ayv-form-wrapper .elementor-col-100{
    width:100% !important;
}

/* Labels */

.ayv-form-wrapper label{
    font-size:15px;
    font-weight:600;
    color:#7A1B3D;
    margin-bottom:8px;
...
.ayv-form-wrapper input,
.ayv-form-wrapper select,
.ayv-form-wrapper textarea{

    width:100%;
    height:58px;

    border:1px solid #e5d7c1 !important;
...
.ayv-form-wrapper input:focus,
.ayv-form-wrapper select:focus,
.ayv-form-wrapper textarea:focus{

    border-color:#9C2247 !important;

    box-shadow:0 0 0 4px rgba(156,34,71,.12) !important;
}

/* Upload */

.ayv-form-wrapper input[type=file]{

    min-height:180px;

    border:2px dashed #d9c39d !important;
...
.ayv-form-wrapper .elementor-button{
    ...
    background:linear-gradient(135deg,#7A1B3D,#C2185B)!important;
...
.ayv-form-wrapper .elementor-button:hover{
...
/* Upload Area */
.ayv-form-wrapper .elementor-field-type-upload{
    position:relative;
    border:2px dashed #d39a3c;
    border-radius:30px;
    background:#f8f8f8;
    padding:30px;
    overflow:hidden;
...
.ayv-form-wrapper .elementor-upload-field{
    width:100%;
    height:260px;
    opacity:0;
    cursor:pointer;
...
/* Cloud Icon */
.ayv-form-wrapper .elementor-field-type-upload:before{
    content:"☁";
    font-size:60px;
    color:#c7903c;
    position:absolute;
...
/* Upload Text */
.ayv-form-wrapper .elementor-field-type-upload:after{
    content:"Click to browse or drag file here\A Maximum file size: 5MB (.pdf)";
    white-space:pre;
    text-align:center;
    position:absolute;
    left:50%;
...
/* Hide original label */
.ayv-form-wrapper .elementor-field-type-upload .elementor-field-label{
    display:none !important;
}

/* Hide native file text */
.ayv-form-wrapper input[type=file]{
    position:absolute;
    inset:0;
    width:100%;
...
/* Heading */
.ayv-form-wrapper .elementor-field-type-upload::after{
    content:"Upload Abstract (PDF only) *\A\A Click to browse or drag file here\A Maximum file size: 5MB (.pdf)";
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-84 current_page_item menu-item-14325"><a aria-current="page" class="elementor-item elementor-item-active" href="/call-for-paper">CALL FOR ABSTRACTS</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-84 current_page_item menu-item-14325"><a aria-current="page" class="elementor-item elementor-item-active" href="/call-for-paper" tabindex="-1">CALL FOR ABSTRACTS</a></li>
...
<div class="elementor elementor-84" data-elementor-id="84" data-elementor-post-type="page" data-elementor-type="wp-page">
<section class="elementor-section elementor-top-section elementor-element elementor-element-24962541 elementor-section-height-min-height elementor-section-content-middle elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-section-boxed elementor-section-height-default elementor-section-items-middle" data-e-type="section" data-element_type="section" data-id="24962541" data-settings='{"background_background":"classic"}'>
<div class="elementor-background-overlay"></div>
<div class="elementor-container elementor-column-gap-no">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2e40684b" data-e-type="column" data-element_type="column" data-id="2e40684b" data-settings='{"background_background":"classic"}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-42348982 elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="42348982" data-widget_type="heading.default">
<div class="elementor-widget-container">
...
<section class="elementor-section elementor-top-section elementor-element elementor-element-4a4aac44 elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="4a4aac44" data-settings='{"background_background":"classic"}'>
<div class="elementor-background-overlay"></div>
<div class="elementor-container elementor-column-gap-no">
<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-7537329a" data-e-type="column" data-element_type="column" data-id="7537329a">
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-4d6a8f4b elementor-widget elementor-widget-elementskit-heading" data-e-type="widget" data-element_type="widget" data-id="4d6a8f4b" data-widget_type="elementskit-heading.default">
<div class="elementor-widget-container">
<div class="ekit-wid-con"><div class="ekit-heading elementskit-section-title-wraper text_left ekit_heading_tablet- ekit_heading_mobile-"><h6 class="elementskit-section-subtitle">
						Call for Papers
					</h6><h3 class="ekit-heading--title elementskit-section-title">Ayurvedam Foundation</h3> <div class="ekit-heading__description">
<p>Ayurvedam Foundation invites researchers, scholars, and practitioners to present their innovative studies at Ayurved Yashobhoomi 2026. This platform offers an opportunity to showcase groundbreaking research, clinical findings, and technological advancements in Ayurveda.</p>
</div>
</div></div> </div>
</div>
<div class="elementor-element elementor-element-5ca42d4 elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="5ca42d4" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h5 class="elementor-heading-title elementor-size-default">Themes &amp; Categories
</h5> </div>
</div>
<div class="elementor-element elementor-element-9c10709 elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="9c10709" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p><span style="font-weight: 400;">We welcome papers on the following specializations:</span></p> </div>
</div>
<div class="elementor-element elementor-element-e4bb518 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-e-type="widget" data-element_type="widget" data-id="e4bb518" data-widget_type="icon-list.default">
<div class="elementor-widget-container">
<ul class="elementor-icon-list-items">
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Kayachikitsa &amp; Panchakarma – Chronic diseases, detoxification, and rejuvenation.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Stri Roga &amp; Prasuti Tantra – Women’s health and prenatal care.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Kaumarbhritya - Bal Roga – Pediatric Ayurveda practices.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Ayurveda Sharir – Anatomy, physiology, and clinical applications.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Shalya Tantra – Kshar, Agni, Viddha, and Anushastra Karma techniques.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Swasthavritha, Yoga &amp; Ayush Ahara – Preventive healthcare, diet, and lifestyle.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Shalakya Tantra – UrdhvajatruGat Roga (ENT &amp; ophthalmology disorders).</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text"> Dravya Guna, Rasa Shastra &amp; Bhaishajya Kalpana – Medicinal properties and formulations.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Agada Tantra &amp; Vidhi Vaidyaka – Toxicology and forensic Ayurveda.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Ayurved Samhita, Siddhanta &amp; Manuscriptology – Classical texts and their interpretations.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Technological Innovations in Ayurveda – AI, telemedicine, and modern research</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">AyurOncology, AyurCosmetology &amp; Super Specialities – Emerging Ayurvedic fields.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Rog Nidan &amp; Vikriti Vigyan – Diagnosis and pathology.</span>
</li>
<li class="elementor-icon-list-item">
<span class="elementor-icon-list-icon">
<svg aria-hidden="true" class="e-font-icon-svg e-far-dot-circle" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"></path></svg> </span>
<span class="elementor-icon-list-text">Dravya Guna – Herbology and pharmacology.</span>
</li>
</ul>
</div>
</div>
...
<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-54c2791f" data-e-type="column" data-element_type="column" data-id="54c2791f">
<div class="elementor-widget-wrap elementor-element-populated">
<section class="elementor-section elementor-inner-section elementor-element elementor-element-10698e0d elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="10698e0d">
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-860bb28 elementor-invisible" data-e-type="column" data-element_type="column" data-id="860bb28" data-settings='{"background_background":"classic","animation":"fadeInRight","animation_delay":500}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-f233c4f elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="f233c4f" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h4 class="elementor-heading-title elementor-size-default">Submission Guidelines</h4> </div>
</div>
<div class="elementor-element elementor-element-62186af elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="62186af" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p><b>Abstract Length:</b><span style="font-weight: 400;"> Maximum 300 words.</span></p><p><b>Format:</b><span style="font-weight: 400;"> Title, Objectives, Methodology, Results, and Conclusion.</span></p><p><b>Language:</b><span style="font-weight: 400;"> English or Hindi.</span></p><p><b>Originality:</b><span style="font-weight: 400;"> Only unpublished work will be accepted.</span></p> </div>
</div>
</div>
</div>
</div>
</section>
<section class="elementor-section elementor-inner-section elementor-element elementor-element-3428048 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="3428048">
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-b2cf2e2 elementor-invisible" data-e-type="column" data-element_type="column" data-id="b2cf2e2" data-settings='{"background_background":"classic","animation":"fadeInRight","animation_delay":400}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-47b01d8 elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="47b01d8" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h4 class="elementor-heading-title elementor-size-default">Important Dates</h4> </div>
</div>
<div class="elementor-element elementor-element-0baaa5f elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="0baaa5f" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p><b>31st August 2026:</b><span style="font-weight: 400;"> Abstract submission deadline.</span></p><p><b>30th September 2026:</b><span style="font-weight: 400;"> Presentation submission deadline.</span></p><p><b>31st October 2026:</b><span style="font-weight: 400;"> Notification of acceptance.</span></p> </div>
</div>
</div>
</div>
</div>
</section>
<section class="elementor-section elementor-inner-section elementor-element elementor-element-511bf84 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="511bf84">
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-1699727 elementor-invisible" data-e-type="column" data-element_type="column" data-id="1699727" data-settings='{"background_background":"classic","animation":"fadeInRight","animation_delay":300}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-227d42c elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="227d42c" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h4 class="elementor-heading-title elementor-size-default">Presentation Details
</h4> </div>
</div>
<div class="elementor-element elementor-element-4e3c8af elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="4e3c8af" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p><b>Points to Remember:</b></p><p><b>Original Work:</b><span style="font-weight: 400;"> Must be conceptual and original by the scholar.</span></p><p><b>Medium of Presentation</b><span style="font-weight: 400;">: English/Hindi (Practitioners’ case studies allowed in Marathi/Hindi).</span></p><p><b>Format:</b><span style="font-weight: 400;"> IMRAD (Introduction, Materials, Results &amp; Discussion), except for case studies and conceptual papers.</span></p><p><b>Time Allotted</b><span style="font-weight: 400;">: 5+2 minutes.</span></p> </div>
</div>
</div>
</div>
</div>
</section>
<section class="elementor-section elementor-inner-section elementor-element elementor-element-4fc2ddc elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="4fc2ddc">
<div class="elementor-container elementor-column-gap-default">
<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-cabb5ac elementor-invisible" data-e-type="column" data-element_type="column" data-id="cabb5ac" data-settings='{"background_background":"classic","animation":"fadeInRight","animation_delay":200}'>
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-750cdfe elementor-widget elementor-widget-heading" data-e-type="widget" data-element_type="widget" data-id="750cdfe" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h4 class="elementor-heading-title elementor-size-default">Presentation Details
</h4> </div>
</div>
<div class="elementor-element elementor-element-4279391 elementor-widget elementor-widget-text-editor" data-e-type="widget" data-element_type="widget" data-id="4279391" data-widget_type="text-editor.default">
<div class="elementor-widget-container">
<p><span style="font-weight: 400;">Receipt of Registration.</span></p>
<p><span style="font-weight: 400;">Brief Bio-data.</span></p>
<p><b>Abstract:</b><span style="font-weight: 400;"> 300 words.</span></p>
<p><b>Poster</b><span style="font-weight: 400;">: PDF format (3×2).</span></p>
<p><b>Paper:</b><span style="font-weight: 400;"> PPT file.</span></p>
<p><b>Email:</b><span style="font-weight: 400;"> Abstact.Ayurved@gmail.com</span></p> </div>
</div>
</div>
</div>
</div>
...
<div class="elementor-element elementor-element-4a1a4ae e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="4a1a4ae">
<div class="elementor-element elementor-element-41c4ef7 elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="41c4ef7" data-widget_type="html.default">
<div class="elementor-widget-container">
<!-- ================================================================
  AYURVED YASHOBHOOMI 2026 — Call for Papers & Abstracts
================================================================= -->
...
<div id="ayv-root">
<!-- ================= HERO ================= -->
<section class="abstract-hero">
<div class="ayv-wrap">
<span class="ayv-eyebrow">Ayurved Yashobhoomi 2026</span>
<h1>Call for Scientific Papers &amp; Posters</h1>
<p>We invite academicians, practitioners, researchers, and scholars to share their clinical expertise, innovative research, and case studies with over 2,500 Ayurveda professionals.</p>
<div style="display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; width: 100%;">
<a class="ayv-btn" href="#submit-abstract"><i class="fas fa-paper-plane"></i> Submit Abstract</a>
<a class="ayv-btn outline" href="#guidelines" style="border-color: rgba(255,255,255,0.4); color: #fff !important;">Read Guidelines</a>
</div>
</div>
</section>
<!-- ================= IMPORTANT DATES ================= -->
...
<h4>31 August 2026</h4>
<p>Abstract Submission Deadline</p>
<span class="tag">Strict Deadline</span>
</div>
<div class="date-card">
<div class="icon"><i class="fas fa-envelope-open-text"></i></div>
<h4>30 September 2026</h4>
<p>Notification of Acceptance</p>
</div>
<div class="date-card">
<div class="icon"><i class="fas fa-user-check"></i></div>
<h4>31 October 2026</h4>
<p>Registration of Presenters</p>
</div>
</div>
</div>
</section>
<!-- ================= GUIDELINES ================= -->
<section id="guidelines" style="background: var(--ivory);">
<div class="ayv-wrap">
<div style="text-align: center; margin-bottom: 50px;">
<span class="ayv-eyebrow">Preparation</span>
<h2 style="font-size: clamp(30px, 4vw, 42px); color: var(--maroon);">Submission Guidelines</h2>
</div>
...
<h3>General Rules</h3>
<ul>
<li><i class="fas fa-check-circle"></i> The research must be original and not previously published or presented elsewhere.</li>
<li><i class="fas fa-check-circle"></i> The presenting author <b>must be a registered delegate</b> for Ayurved Yashobhoomi 2026.</li>
<li><i class="fas fa-check-circle"></i> Plagiarism will lead to immediate rejection. All abstracts will undergo a strict peer-review process.</li>
<li><i class="fas fa-check-circle"></i> Outstanding research papers will be eligible for a total prize pool of <b>₹25,000</b>.</li>
</ul>
</div>
<!-- Step 2 -->
<div class="guideline-box">
...
<ul>
<li><i class="fas fa-file-alt"></i> <b>Font &amp; Size:</b> Times New Roman, 12 pt size, 1.5 line spacing.</li>
<li><i class="fas fa-file-alt"></i> <b>Language:</b> English or Hindi (Unicode font required for Hindi).</li>
<li><i class="fas fa-file-alt"></i> <b>Title:</b> Keep it concise, bold, and centered.</li>
<li><i class="fas fa-file-alt"></i> <b>Author Details:</b> Include full name, designation, institution, email, and mobile number. (Underline the presenting author).</li>
</ul>
</div>
<!-- Step 3 -->
<div class="guideline-box">
<div class="step-num">3</div>
<h3>Abstract Layout &amp; Word Limit</h3>
<ul>
<li><i class="fas fa-align-left"></i> <b>Word Limit:</b> The abstract should be between 250 - 300 words.</li>
<li><i class="fas fa-align-left"></i> <b>Structure:</b> Background, Aim/Objective, Materials &amp; Methods, Results, and Conclusion.</li>
<li><i class="fas fa-align-left"></i> <b>Keywords:</b> Provide 3 to 5 relevant keywords at the bottom of the abstract.</li>
<li><i class="fas fa-align-left"></i> <b>File Format:</b> Submit in MS Word (.doc or .docx) format only. PDFs are not accepted for review.</li>
</ul>
</div>
</div>
</div>
...
<!-- ================= THEMES ================= -->
<section style="background: linear-gradient(180deg, var(--ivory), #F3E9D2);">
<div class="ayv-wrap">
<div style="text-align: center; margin-bottom: 20px;">
<span class="ayv-eyebrow">Categories</span>
<h2 style="font-size: clamp(30px, 4vw, 42px); color: var(--maroon);">Themes for Papers &amp; Posters</h2>
</div>
<div class="theme-grid">
<div class="theme-card"><h4>Prasuti Tantra &amp; Stree Roga</h4><p>Garbhasanskar, maternal wellness &amp; reproductive health.</p></div>
<div class="theme-card"><h4>Kaumarbhritya</h4><p>Ayurveda in child growth &amp; preventive pediatric care.</p></div>
<div class="theme-card"><h4>Swasthavritta &amp; Yoga</h4><p>Lifestyle disorders, yoga &amp; mental well-being.</p></div>
<div class="theme-card"><h4>Shalakya Tantra</h4><p>Preventive ENT, eye &amp; dental care through Ayurveda.</p></div>
<div class="theme-card"><h4>Kayachikitsa</h4><p>Evidence-based internal medicine practices &amp; clinical success.</p></div>
<div class="theme-card"><h4>Rasa Shastra &amp; Bhaishajya</h4><p>Standardisation of Ayurvedic formulations &amp; pharmacology.</p></div>
<div class="theme-card"><h4>Manasa Chikitsa</h4><p>Stress, anxiety &amp; mind-body integration in modern life.</p></div>
<div class="theme-card"><h4>Shalya Tantra</h4><p>Advances in Ksharasutra, Agnikarma &amp; para-surgical techniques.</p></div>
<div class="theme-card"><h4>Panchakarma</h4><p>Evidence-based outcomes of detox and purification therapies.</p></div>
<div class="theme-card"><h4>Kriya &amp; Rachana Sharir</h4><p>Functional physiology, applied anatomy, and basic principles.</p></div>
<div class="theme-card"><h4>Roga Nidana</h4><p>Diagnostic methodologies, clinical pathology &amp; emerging research.</p></div>
<div class="theme-card"><h4>Dravyaguna &amp; Agad Tantra</h4><p>Medicinal plants, toxicology, and clinical applications.</p></div>
</div>
</div>
</section>
<!-- ================= SUBMISSION FORM ================= -->
<section id="submit-abstract" style="background: #F3E9D2;">
<div class="ayv-wrap">
<div class="ayv-form-wrapper">
<div style="text-align: center; margin-bottom: 40px;">
<span class="ayv-eyebrow">Online Submission</span>
<h2 style="font-size: clamp(28px, 4vw, 36px); color: var(--maroon); margin-bottom: 12px;">Submit Your Abstract</h2>
<p style="font-size: 16px; color: #473C34; max-width: 600px; margin: 0 auto;">Please fill out the form below and attach your abstract in MS Word (.doc/.docx) format. Deadline: <b>31 August 2026</b>.</p>
</div>
<!-- ELEMENTOR SHORTCODE INSERTED HERE -->
<div class="elementor elementor-14713" data-elementor-id="14713" data-elementor-post-type="elementor_library" data-elementor-type="container">
<div class="elementor-element elementor-element-d702fda e-flex e-con-boxed e-con e-parent" data-e-type="container" data-element_type="container" data-id="d702fda">
<div class="e-con-inner">
<div class="elementor-element elementor-element-e26c0e3 elementor-button-align-stretch elementor-widget elementor-widget-form" data-e-type="widget" data-element_type="widget" data-id="e26c0e3" data-settings='{"step_next_label":"Next","step_previous_label":"Previous","button_width":"100","step_type":"number_text","step_icon_shape":"circle"}' data-widget_type="form.default">
<div class="elementor-widget-container">
<form aria-label="Abstract submission" class="elementor-form" method="post" name="Abstract submission">
<input name="post_id" type="hidden" value="14713"/>
<input name="form_id" type="hidden" value="e26c0e3"/>
<input name="referer_title" type="hidden" value="CALL FOR ABSTRACTS"/>
<input name="queried_id" type="hidden" value="84"/>
<div class="elementor-form-fields-wrapper elementor-labels-above">
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-50 elementor-field-required">
<label class="elementor-field-label" for="form-field-name">
								Full Name 							</label>
<input class="elementor-field elementor-size-lg elementor-field-textual" id="form-field-name" name="form_fields[name]" placeholder="Dr. / Vd. First Last" required="required" size="1" type="text"/>
</div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-50 elementor-field-required">
<label class="elementor-field-label" for="form-field-email">
								Email Address 							</label>
<input class="elementor-field elementor-size-lg elementor-field-textual" id="form-field-email" name="form_fields[email]" placeholder="your@email.com" required="required" size="1" type="email"/>
</div>
<div class="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-field_b469171 elementor-col-50">
<label class="elementor-field-label" for="form-field-field_b469171">
								Phone Number							</label>
<input class="elementor-field elementor-size-lg elementor-field-textual" id="form-field-field_b469171" name="form_fields[field_b469171]" pattern="[0-9()#&amp;+*-=.]+" placeholder="+91" size="1" title="Only numbers and phone characters (#, -, *, etc) are accepted." type="tel"/>
</div>
<div class="elementor-field-type-select elementor-field-group elementor-column elementor-field-group-field_193f09d elementor-col-50">
<label class="elementor-field-label" for="form-field-field_193f09d">
								Select Theme / Category *							</label>
<div class="elementor-field elementor-select-wrapper remove-before">
<div class="select-caret-down-wrapper">
<svg aria-hidden="true" class="e-font-icon-svg e-eicon-caret-down" viewbox="0 0 571.4 571.4" xmlns="http://www.w3.org/2000/svg"><path d="M571 393Q571 407 561 418L311 668Q300 679 286 679T261 668L11 418Q0 407 0 393T11 368 36 357H536Q550 357 561 368T571 393Z"></path></svg> </div>
<select class="elementor-field-textual elementor-size-lg" id="form-field-field_193f09d" name="form_fields[field_193f09d]">
...
<option value="Rasa Shastra &amp; Bhaishajya">Rasa Shastra &amp; Bhaishajya</option>
<option value="Manasa Chikitsa">Manasa Chikitsa</option>
<option value="Shalya Tantra">Shalya Tantra</option>
<option value="Panchakarma">Panchakarma</option>
<option value="Kriya &amp; Rachana Sharir">Kriya &amp; Rachana Sharir</option>
<option value="Roga Nidana">Roga Nidana</option>
<option value="Dravyaguna &amp; Agad Tantra">Dravyaguna &amp; Agad Tantra</option>
<option value=""></option>
</select>
</div>
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_03e949e elementor-col-100">
<label class="elementor-field-label" for="form-field-field_03e949e">
								Abstract Title 							</label>
<input class="elementor-field elementor-size-lg elementor-field-textual" id="form-field-field_03e949e" name="form_fields[field_03e949e]" placeholder="Enter the exact title of your paper or poster " size="1" type="text"/>
</div>
<div class="elementor-field-type-upload elementor-field-group elementor-column elementor-field-group-field_cfee55e elementor-col-100">
<label class="elementor-field-label" for="form-field-field_cfee55e">
								Upload Abstract (PDF only) *							</label>
<input class="elementor-field elementor-size-lg elementor-upload-field" data-maxsize="30" data-maxsize-message="This file exceeds the maximum allowed size." id="form-field-field_cfee55e" name="form_fields[field_cfee55e]" type="file"/>
</div>
<div class="elementor-field-group elementor-column elementor-field-type-submit elementor-col-100 e-form__buttons">
<button class="elementor-button elementor-size-md" type="submit">
<span class="elementor-button-content-wrapper">
<span class="elementor-button-text"> Submit Abstract Application</span>
</span>
</button>
</div>
</div>
