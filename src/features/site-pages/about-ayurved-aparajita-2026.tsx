...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-11120 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-11120" />
      ...
      <link rel="stylesheet" id="elementor-post-11120-css" href="/css/elementor-post-11120.css" media="all" />
...
`
      ...
      <style id="style-inline-about-ayurved-aparajita-2026-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-about-ayurved-aparajita-2026-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-about-ayurved-aparajita-2026-7" dangerouslySetInnerHTML={{
        __html: `
  /* --- SCOPED ROOT VARIABLES & RESET --- */
  .ayurved-aparajita-story {
    --ink: #210c12;
    --ink-light: #4a2a36;
    --leaf: #6E1A3D;
    --magenta: #C2185B;
  ...
  .aparajita-tracks-container {
    margin-bottom: 80px !important;
  }

  .aparajita-tracks-grid {
    display: grid !important;
    grid-template-columns: repeat(4, 1fr) !important;
    gap: 20px !important;
  }

  .aparajita-track-card {
    background: rgba(110,26,61,0.03) !important;
    border: 1px solid var(--line) !important;
  ...
  /* --- PRICING SECTION --- */
  .aparajita-pricing-section {
    margin-bottom: 80px !important;
  }

  .aparajita-pricing-grid {
    display: grid !important;
    grid-template-columns: repeat(3, 1fr) !important;
    gap: 30px !important;
  }

  .aparajita-price-card {
    background: #ffffff !important;
    border: 1px solid var(--line) !important;
    border-radius: 24px !important;
    ...
    display: flex !important;
    flex-direction: column !important;
    box-shadow: 0 8px 24px rgba(110,26,61,.03) !important;
    position: relative !important;
    overflow: hidden !important;
  }

  .aparajita-price-card.featured {
    border: 2px solid var(--gold) !important;
    box-shadow: 0 15px 35px rgba(201,138,42,0.1) !important;
  }

  .aparajita-price-card .seat-badge {
    position: absolute !important;
    top: 15px !important;
  ...
  .aparajita-price-card .target-gender {
    font-size: 12px !important;
    text-transform: uppercase !important;
    letter-spacing: 0.05em !important;
  ...
  .aparajita-price-card .price-amount {
    font-family: 'Fraunces', serif !important;
  ...
  .aparajita-price-card .section-divider {
    border-bottom: 1px solid #eee;
    margin-bottom: 25px !important;
  }

  .aparajita-price-card .info-header {
    font-size: 12px !important;
    text-transform: uppercase !important;
    color: var(--clay) !important;
    font-weight: 700 !important;
  ...
  .aparajita-price-card ul {
    list-style: none !important;
    padding: 0 !important;
    margin: 0 0 30px 0 !important;
  }

  .aparajita-price-card ul li {
    font-size: 14px !important;
    color: var(--ink-light) !important;
    margin-bottom: 10px !important;
    position: relative !important;
  ...
  .aparajita-price-card ul li::before {
    content: "✦" !important;
    position: absolute !important;
    left: 0 !important;
  ...
  .aparajita-price-card .cta-btn:hover {
    background: var(--magenta) !important;
    transform: translateY(-2px) !important;
  }

  .aparajita-price-card.featured .cta-btn {
    background: linear-gradient(135deg, var(--gold), var(--clay)) !important;
  }

  .aparajita-notice-box {
    background: #ffffff !important;
    border: 1px dashed var(--magenta) !important;
    border-radius: 16px !important;
  ...
  .aparajita-partner-card .patronage {
    font-size: 11px !important;
    text-transform: uppercase !important;
    letter-spacing: 1px !important;
    color: var(--gold) !important;
  ...
  @media (max-width: 1024px) {
    .aparajita-tracks-grid { grid-template-columns: repeat(2, 1fr) !important; }
    .aparajita-pricing-grid { grid-template-columns: 1fr !important; gap: 24px !important; }
    .aparajita-partners-grid { grid-template-columns: 1fr !important; gap: 20px !important; }
  }

  @media (max-width: 992px) {
    .aparajita-story-section { grid-template-columns: 1fr !important; gap: 40px !important; }
  }

  @media (max-width: 768px) {
    .aparajita-meta-grid { grid-template-columns: 1fr !important; gap: 24px !important; padding: 25px !important; }
    .ayurved-aparajita-story { padding: 40px 0 60px !important; }
    .aparajita-wrap { padding: 0 20px !important; }
    .aparajita-footer { padding: 35px 20px !important; }
  }
`
      }} />
...
<ul class="sub-menu elementor-nav-menu--dropdown">
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11120 current_page_item menu-item-11231"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/about-ayurved-aparajita-2026">ABOUT AYURVED APARAJITA 2026</a></li>
...
<ul class="sub-menu elementor-nav-menu--dropdown">
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11120 current_page_item menu-item-11231"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/about-ayurved-aparajita-2026" tabindex="-1">ABOUT AYURVED APARAJITA 2026</a></li>
...
<div class="elementor elementor-11120" data-elementor-id="11120" data-elementor-post-type="page" data-elementor-type="wp-page">
<section class="elementor-section elementor-top-section elementor-element elementor-element-cd06cd5 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-e-type="section" data-element_type="section" data-id="cd06cd5">
<div class="elementor-container elementor-column-gap-no">
<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-8b83ba5" data-e-type="column" data-element_type="column" data-id="8b83ba5">
<div class="elementor-widget-wrap elementor-element-populated">
<div class="elementor-element elementor-element-11d810a elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="11d810a" data-widget_type="html.default">
<div class="elementor-widget-container">
<link href="https://fonts.googleapis.com" rel="preconnect"/>
<link crossorigin="" href="https://fonts.gstatic.com" rel="preconnect"/>


<div class="ayurved-aparajita-story">
<div class="aparajita-wrap">
<!-- HEADER -->
<header class="aparajita-hero">
<span class="success-badge">✨ Conclave Concluded</span>
<h1>Ayurved Aparajita 2026</h1>
<p class="tagline">A National Conclave Dedicated to the Women of Ayurveda</p>
<span class="quote">"Give to Gain – When a woman gives, the world gains."</span>
</header>
<!-- METADATA RETROSPECTIVE BLOCK -->
<div class="aparajita-meta-grid">
<div class="aparajita-meta-item">
<div class="aparajita-meta-icon">📆</div>
<div class="aparajita-meta-text">
<h3>Concluded Timeline</h3>
<p>8th March 2026</p>
</div>
</div>
<div class="aparajita-meta-item">
<div class="aparajita-meta-icon">🏛️</div>
<div class="aparajita-meta-text">
<h3>Historical Venue</h3>
<p>Constitution Club of India, New Delhi</p>
</div>
</div>
</div>
<!-- MAIN SUMMARY SECTION -->
<section class="aparajita-story-section">
<div class="aparajita-story-text">
<h2>Vision &amp; Historical Philosophy</h2>
<p>Organized flawlessly by the <strong>Ayurvedam Foundation</strong> to commemorate International Women's Day, Ayurved Aparajita 2026 emerged as a groundbreaking national-level forum. Ayurveda has eternally revered the primordial feminine matrix—Shakti. This milestone conclave served as a monumental strategic investment into modern global health structures, driving structural transformation directly to its delegates.</p>
<p>Established natively under the stewardship of <strong>Vaidya Brijesh Prajapati &amp; Team</strong>, Ayurvedam Foundation bridges the deep structural chasm separating classical ancient methodologies from modern live clinical practices. Moving aggressively forward following the high-impact success of Ayurved Anantam 2025, this summit marks our next grand evolutionary leap.</p>
</div>
<!-- Statistics Stacked Tracker -->
<div class="aparajita-stat-grid">
<div class="aparajita-stat-box">
<span class="aparajita-stat-number">1,200+</span>
<span class="aparajita-stat-label">Women Ayurvedacharyas, Practicing Doctors &amp; Leaders Empowered</span>
</div>
</div>
</section>
<!-- FOUR PILLARS ECOSYSTEM SECTION -->
<div class="aparajita-tracks-container">
<h3 class="aparajita-features-title">The Conclave Core Ecosystem</h3>
<div class="aparajita-tracks-grid">
<div class="aparajita-track-card">
<h4>Aparajita</h4>
...
<div class="aparajita-track-card">
<h4>Exhibition</h4>
<p>Women-Centric Brands</p>
</div>
</div>
</div>
<!-- MILESTONES ACHIEVED MATRIX -->
<h3 class="aparajita-features-title">Conclave Tracks &amp; Breakthroughs Achieved</h3>
<p class="aparajita-features-subtitle">A look back at the specialized medical frameworks that defined the summit's success</p>
<div class="aparajita-features-grid">
<!-- Card 1 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">🤰</span>
<h4>Garbhasanskar &amp; Infertility</h4>
<p>Deep-dive clinical segments on traditional preconception care methodologies, maternal well-being, and structured holistic fertility management matrices.</p>
</div>
<!-- Card 2 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">🎗️</span>
<h4>Gynecological Oncology</h4>
<p>Critical tracking of integrative Ayurvedic approaches in prevention, complementary supportive care, and long-term quality-of-life enhancement metrics.</p>
</div>
<!-- Card 3 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">✨</span>
<h4>Ayurvedic Cosmetology</h4>
<p>Reviewing clinical portfolios of classical and contemporary botanical solutions engineered for modern skin, hair, and aesthetic wellness demands.</p>
</div>
<!-- Card 4 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">🚀</span>
<h4>Clinical Entrepreneurship</h4>
<p>Empowering dynamic female practitioners with proper commercial guidance to successfully establish ethical, highly sustainable, and impactful ventures.</p>
</div>
<!-- Card 5 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">🏛️</span>
<h4>Aparajita Samman</h4>
<p>A dedicated, high-impact award ceremony honoring exceptional female leaders who have devoted their lives and practices to the preservation of Ayurveda.</p>
</div>
<!-- Card 6 -->
<div class="aparajita-feature-card">
<span class="aparajita-card-icon">🛍️</span>
<h4>30+ Brand Exhibition</h4>
<p>A highly popular expo gallery featuring female-centric pharmacological formulations, wellness innovations, and ethical consumer items.</p>
</div>
</div>
<!-- ESTEEMED PARTNERS -->
<div style="margin-top: 100px;">
<h3 class="aparajita-partners-title">Our Esteemed Institutional Partners</h3>
<div class="aparajita-partners-grid">
<div class="aparajita-partner-card">
<span class="patronage">Under the Patronage of</span>
<h4>Akhil Bhartiya Ayurved Mahasammelan Trust</h4>
<p>A nationally respected apex body committed permanently to the active preservation and systemic promotion of classical Ayurveda across India.</p>
</div>
<div class="aparajita-partner-card">
<span class="patronage">Institutional Partner</span>
<h4>Rashtriya Ayurved Vidyapeeth (RAV)</h4>
<p>An autonomous elite apex organization operating directly under the Ministry of AYUSH, Government of India, dedicated to academic excellence.</p>
</div>
<div class="aparajita-partner-card">
<span class="patronage">Supported By</span>
<h4>BRICS Chamber of Commerce &amp; Industry</h4>
<p>A globally recognized powerhouse forum effectively fostering international collaboration, healthcare innovation, and macroeconomic cooperation.</p>
</div>
</div>
</div>
<!-- FOOTER CLOSING CTA -->
<footer class="aparajita-footer">
<h2>Ayurvedam Foundation</h2>
<p>Bridging Classical Wisdom and Clinical Practice Natively.</p>
<div class="aparajita-footer-meta">
<span>📧 <a href="mailto:info@ayurvedamfoundation.org">info@ayurvedamfoundation.org</a></span>
...
<div class="elementor-element elementor-element-839372f e-flex e-con-boxed e-con e-parent" data-e-type="container" data-element_type="container" data-id="839372f" data-settings='{"background_background":"classic"}'>
<div class="e-con-inner">
<div class="elementor-element elementor-element-6d2ed3f elementor-widget elementor-widget-gallery" data-e-type="widget" data-element_type="widget" data-id="6d2ed3f" data-settings='{"gallery_layout":"masonry","gap":{"unit":"px","size":14,"sizes":[]},"lazyload":"yes","columns":4,"columns_tablet":2,"columns_mobile":1,"gap_tablet":{"unit":"px","size":10,"sizes":[]},"gap_mobile":{"unit":"px","size":10,"sizes":[]},"link_to":"file","overlay_background":"yes","content_hover_animation":"fade-in"}' data-widget_type="gallery.default">
<div class="elementor-widget-container">
<div class="elementor-gallery__container">
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDEsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtNDEtc2NhbGVkLndlYnAiLCJzbGlkZXNob3ciOiI2ZDJlZDNmIn0%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (41)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-41-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-41-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDIsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtNjEtc2NhbGVkLndlYnAiLCJzbGlkZXNob3ciOiI2ZDJlZDNmIn0%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (61)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-61-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-61-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDMsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtNzQ0LXNjYWxlZC53ZWJwIiwic2xpZGVzaG93IjoiNmQyZWQzZiJ9" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (744)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-744-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-744-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDQsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMTQ0Mi53ZWJwIiwic2xpZGVzaG93IjoiNmQyZWQzZiJ9" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (1442)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-1442.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="974" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-1442-841x1024.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDUsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMTYwMS1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (1601)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-1601-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-1601-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDYsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMTYxNS1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (1615)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-1615-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-1615-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDcsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMTY0NC1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (1644)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-1644-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-1644-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDgsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMTY0NS1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (1645)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-1645-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-1645-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNDksInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMjY1MS1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (2651)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-2651-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-2651-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
<a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MTUwNTAsInVybCI6Imh0dHBzOlwvXC9heXVydmVkYW1mb3VuZGF0aW9uLm9yZ1wvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNlwvMDZcL0EtMjY3MS1zY2FsZWQud2VicCIsInNsaWRlc2hvdyI6IjZkMmVkM2YifQ%3D%3D" data-elementor-lightbox-slideshow="6d2ed3f" data-elementor-lightbox-title="A (2671)" data-elementor-open-lightbox="yes" href="/uploads/2026/06/A-2671-scaled.webp">
<div aria-label="" class="e-gallery-image elementor-gallery-item__image" data-height="534" data-thumbnail="https://ayurvedamfoundation.org/uploads/2026/06/A-2671-1024x683.webp" data-width="800" role="img"></div>
<div class="elementor-gallery-item__overlay"></div>
</a>
</div>
</div>
