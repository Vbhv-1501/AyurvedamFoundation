...
const PARTNERS: Partner[] = [
  {
    id: "yasharth-veda-foundation",
    orgLogo: "/uploads/2025/03/WhatsApp-Image-2025-03-25-at-10.00.23-PM-1-1024x1024.jpeg",
    orgInitials: "YV",
    personImage: "/uploads/2025/03/yash-chaudhary-1.jpeg",
    personInitials: "YC",
    name: "Vd. Yash Chaudhary",
    role: "Founder, Yasharth Veda Foundation",
    phone: "+91 76690 89388",
  },
  {
    id: "atharva-ayurveda-society",
    orgLogo: "/uploads/2025/03/WhatsApp-Image-2025-03-25-at-10.00.24-PM-2-1024x791.jpeg",
    orgInitials: "AA",
    personImage: "/uploads/2025/03/vaidya-lalit-bansal-e1742921637896.jpg",
    personInitials: "LB",
    name: "Vd. Lalit Bansal",
    role: "Co-founder, Atharva Ayurveda Society (Regd)",
    phone: "+91 86992 34555",
  },
  {
    id: "ayurgange-foundation",
    orgLogo: "/uploads/2025/03/WhatsApp-Image-2025-03-25-at-10.00.24-PM-1-1024x1024.jpeg",
    orgInitials: "AF",
    personImage: "/uploads/2025/03/Ashu-e1742921050872.jpg",
    personInitials: "VA",
    name: "Vd. Ashutosh",
    role: "Founder, Ayurgange Foundation",
    phone: "+91 84758 06494",
  },
  {
    id: "arjun-veda-foundation",
    orgLogo: "/uploads/2025/03/WhatsApp-Image-2025-03-25-at-10.00.23-PM-2-1024x1024.jpeg",
    orgInitials: "AV",
    personImage: "/uploads/2025/03/Arjun-Nanda-e1742920427801.jpg",
    personInitials: "AN",
    name: "Vd. Arjun Nanda",
    role: "Founder, Arjun Veda Foundation",
    phone: "+91 84450 50131",
  },
  {
    id: "aagaz-foundation",
    orgLogo: "/uploads/2025/03/WhatsApp-Image-2025-03-25-at-10.00.24-PM-1024x1024.jpeg",
    orgInitials: "AF",
    personImage: "/uploads/2025/03/vd-jaypal-dangar-.jpg",
    personInitials: "JD",
    name: "Vd. Jaypal Dangar",
    role: "Administrative Officer, Aagaz Foundation",
    phone: "+91 87802 35955",
  },
  {
    id: "excellence-ayurveda-academy",
    orgLogo: "/uploads/2025/03/Untitled-design-14.png",
    orgInitials: "EA",
    personImage: "/uploads/2025/03/shadab-ali-siddique-scaled-e1742921430324.jpg",
    personInitials: "SS",
    name: "Vd. Shadab Ali Siddiqui",
    role: "Founder, Excellence Ayurveda Academy",
    phone: "+91 90263 66890",
  },
];
...
const ADVISORS: Advisor[] = [
  {
    ...
    image: "/uploads/2025/03/Dr-Akshay-Goel.jpg",
    initials: "AG",
  },
  {
    id: "navneet-bharadwaj",
    name: "Vd. Navneet Bharadwaj",
    role: "Founder of Navan Ayurveda",
    image: "/uploads/2025/03/Dr-Navneet-Bharadwaj--e1742889292339.jpg",
    initials: "NB",
  },
  {
    id: "bhavani-singh",
    name: "Vd. Bhavani Singh",
    role: "Senior Resident, FOA, IMS, BHU",
    image: "/uploads/2025/03/Dr.-Bhawani-Singh_Senior-Resident_Faculty-of-Ayurveda-IMS-BHU.__Founder-_Mahamana-Ayurveda-Academy.__Founder-_Mahamana-Ayurveda-Academy.__Founder-_Mahamana-Ayurveda-Academy-875x1024.jpeg",
    initials: "BS",
  },
  {
    id: "pallav-prajapati",
    name: "Vd. Pallav Prajapati",
    role: "Founder & Director, Chaitanya Ayurveda",
    image: "/uploads/2025/03/PALLAV-1024x683.jpg",
    initials: "PP",
  },
  {
    id: "mrityunjay-dwivedi",
    name: "Vd. Mrityunjay Dwivedi",
    role: "Medical Officer, Govt. of UP",
    image: "/uploads/2025/03/MRITYUNJAY-e1742889306706.jpg",
    initials: "MD",
  },
];
...
function PartnerCard({ partner, index }: { partner: Partner; index: number }) {
  ...
  return (
    <div ref={ref} className={`card ${inView ? "in-view" : ""}`} style={{ transitionDelay: `${index * 80}ms` }}>
      ...
      >
        {/* Certificate plaque for Partner Logo */}
        <div className="plaque">
          ...
          <div className="seal">
            <svg viewBox="0 0 24 24" fill="none">
              <path
                d="M12 2l1.9 3.9 4.3.6-3.1 3 .7 4.3L12 11.8 8.2 13.8l.7-4.3-3.1-3 4.3-.6L12 2z"
                fill="url(#sealGrad)"
              />
              <defs>
          ...
          <div className="plaque-inner">
            {!logoFailed ? (
              <img src={partner.orgLogo} alt={`${partner.name} logo`} onError={() => setLogoFailed(true)} />
            ) : (
              <span className="org-fallback">{partner.orgInitials}</span>
            )}
          </div>
        </div>
        ...
        {/* Gold coin medallion for Person Photo */}
        <div className="medallion">
          <svg className="scallop" viewBox="0 0 148 148" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id={`gold-${partner.id}`} x1="10%" y1="0%" x2="90%" y2="100%">
            ...
            <path d={SCALLOP_PATH} fill={`url(#gold-${partner.id})`} />
          </svg>
        ...
        {partner.phone && (
          <a className="phone-btn" href={`tel:${partner.phone.replace(/\s+/g, "")}`}>
...
function AdvisorCard({ advisor, index }: { advisor: Advisor; index: number }) {
  ...
  return (
    <div ref={ref} className={`card ${inView ? "in-view" : ""}`} style={{ transitionDelay: `${index * 80}ms` }}>
      <div
        className="card-inner advisor-card-inner"
        onMouseMove={handleMouseMove}
        onMouseLeave={handleMouseLeave}
        style={{ transform: `rotateX(${tilt.y}deg) rotateY(${tilt.x}deg)` }}
      >
        {/* Gold coin medallion for Advisor Photo */}
        <div className="medallion">
          <svg className="scallop" viewBox="0 0 148 148" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id={`gold-adv-${advisor.id}`} x1="10%" y1="0%" x2="90%" y2="100%">
                <stop offset="0%" stopColor="#FCEBC0" />
                <stop offset="35%" stopColor="#E8C077" />
                <stop offset="70%" stopColor="#B8862E" />
                <stop offset="100%" stopColor="#6E4A14" />
            ...
            <path d={SCALLOP_PATH} fill={`url(#gold-adv-${advisor.id})`} />
          </svg>
          <div className="bevel-ring" />
          <div className="bead-rim" />
          <div className="shine" />
...
/* ------------------------------------------------------------------ */
/*  Redesigned Partners & Advisory Section                            */
/* ------------------------------------------------------------------ */

function PartnersAndAdvisorySection() {
  return (
    <div className="partners-page-container">
      ...
      <section className="partners-section">
        <div className="section-header">
          ...
          <h2 className="section-title">Associating Partners</h2>
        </div>

        <div className="cards-grid partners-grid">
      ...
      <section className="advisory-section">
        ...
        <div className="cards-grid advisors-grid">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        /* --- Certificate Plaque for Partners --- */
        .plaque {
          position: relative;
          width: 140px;
          height: 140px;
          border-radius: 18px;
          background: linear-gradient(160deg, #fffdf8, #f6ecdc);
          box-shadow: inset 0 2px 6px rgba(255, 255, 255, 0.9), 
                      inset 0 -3px 8px rgba(140, 95, 30, 0.15),
                      0 14px 24px -14px rgba(120, 60, 15, 0.35);
        ...
        .plaque-inner {
          ...
          inset: 12px;
          border-radius: 10px;
          border: 1px dashed rgba(154, 108, 40, 0.35);
          display: flex;
          align-items: center;
          justify-content: center;
          overflow: hidden;
        ...
        .seal {
          ...
          align-items: center;
          justify-content: center;
          box-shadow: 0 6px 12px -4px rgba(130, 80, 20, 0.5), inset 0 0 0 1px rgba(200, 150, 60, 0.4);
