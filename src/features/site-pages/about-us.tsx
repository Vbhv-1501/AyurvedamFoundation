...
export default function Page() {
  return (
    <>
      <BodyClassManager className="wp-singular page-template page-template-elementor_header_footer page page-id-74 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-template-full-width elementor-kit-26 elementor-page elementor-page-74" />
      ...
      <link rel="stylesheet" id="elementor-post-74-css" href="/css/elementor-post-74.css" media="all" />
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500;9..144,600;9..144,700&family=Outfit:wght@300;400;500;600;700&family=Yatra+One&family=JetBrains+Mono:wght@500;600&display=swap" media="all" />
...
`
      ...
      <style id="style-inline-about-us-4" dangerouslySetInnerHTML={{
        __html: `.woocommerce-product-gallery{ opacity: 1 !important; }`
      }} />
      <style id="style-inline-about-us-5" dangerouslySetInnerHTML={{
        __html: `
...
`
      ...
      <style id="style-inline-about-us-7" dangerouslySetInnerHTML={{
        __html: `
  :root {
    --ink: #210c12;
    --ink-light: #4a2a36;
    ...
    --shadow-lg: 0 24px 48px rgba(110,26,61,.15);
  }
  
  .ayurvedam-about-content {
  ...
  .ayurvedam-about-content * { box-sizing: border-box; }
  .ayurvedam-about-content img { max-width: 100%; display: block; height: auto; }
  
  .ayurvedam-about-content h1, 
  .ayurvedam-about-content h2, 
  .ayurvedam-about-content h3, 
  .ayurvedam-about-content h4 { 
  ...
  .ayurvedam-about-content p { color: var(--ink-light); margin-top: 0; margin-bottom: 18px; }
  
  .ayurvedam-about-content .eyebrow {
  ...
  .ayurvedam-about-content .wrap { max-width: 1200px; margin: 0 auto; padding: 0 32px; }
  .ayurvedam-about-content section { padding: 90px 0; }
  
  /* ===== Hero Section ===== */
  .ayurvedam-about-content .about-hero {
    background: linear-gradient(135deg, #FCF5F0 0%, #F5E5DC 100%);
  ...
  /* Subtle Background Petal for Hero */
  .ayurvedam-about-content .about-hero::before {
    content: '';
    position: absolute;
    width: 600px; height: 600px;
    background: radial-gradient(circle, rgba(194,24,91,0.05), transparent 60%);
    top: -200px; left: -100px;
    border-radius: 50%;
  }

  .ayurvedam-about-content .about-hero h1 {
    font-size: clamp(42px, 6vw, 68px);
    margin-bottom: 20px;
    background: linear-gradient(100deg, var(--leaf), var(--magenta));
  ...
  .ayurvedam-about-content .about-hero .lead {
    font-size: 22px;
    max-width: 700px;
    margin: 0 auto;
    color: var(--leaf);
  ...
  /* ===== Modern Split Intro Section ===== */
  .ayurvedam-about-content .intro-grid {
    display: grid;
    grid-template-columns: 1fr 1fr;
    gap: 72px;
    align-items: center;
  }
  .ayurvedam-about-content .intro-text h2 {
    font-size: 38px;
    margin-bottom: 24px;
    line-height: 1.2;
  }
  .ayurvedam-about-content .intro-text p {
    font-size: 17px;
  }
  
  /* Premium Overlapping Image Composition */
  .ayurvedam-about-content .intro-image-wrapper {
    position: relative;
    padding-bottom: 40px; /* Space for overlapping image */
  }
  .ayurvedam-about-content .intro-image-wrapper .img-main {
    border-radius: 24px;
  ...
  .ayurvedam-about-content .intro-image-wrapper .img-overlap {
    position: absolute;
    bottom: 0;
    right: 0;
    width: 55%;
  ...
  .ayurvedam-about-content .blockquote {
    font-family: 'Fraunces', serif;
    font-size: 26px;
    color: var(--magenta);
    padding: 32px 0;
  ...
  .ayurvedam-about-content .vm-grid {
    display: grid;
    grid-template-columns: 1fr 1fr;
    gap: 32px;
  }
  .ayurvedam-about-content .vm-card {
    background: #fff;
    border-radius: 24px;
    padding: 48px;
  ...
  .ayurvedam-about-content .vm-card:hover { 
    transform: translateY(-8px); 
    box-shadow: var(--shadow-lg); 
    border-color: rgba(194,24,91,0.2);
  }
  .ayurvedam-about-content .vm-card h3 { font-size: 32px; color: var(--leaf); margin-bottom: 20px; }
  .ayurvedam-about-content .vm-card ul { padding-left: 24px; margin-top: 20px; }
  .ayurvedam-about-content .vm-card li { margin-bottom: 12px; color: var(--ink-light); }
  .ayurvedam-about-content .vm-card li::marker { color: var(--gold); font-size: 1.2em; }

  /* ===== Grids for Who We Are & Why It Matters ===== */
  .ayurvedam-about-content .section-head { text-align: center; max-width: 800px; margin: 0 auto 56px; }
  .ayurvedam-about-content .section-head h2 { font-size: 40px; margin-bottom: 16px; }
  
  .ayurvedam-about-content .feature-grid {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(320px, 1fr));
    gap: 24px;
  }
  .ayurvedam-about-content .feature-card {
  ...
  .ayurvedam-about-content .feature-card:hover {
    background: #fff;
    box-shadow: var(--shadow-md);
    border-color: rgba(194,24,91,0.3);
    transform: translateY(-4px);
  }
  .ayurvedam-about-content .feature-card h4 { font-size: 22px; margin-bottom: 12px; color: var(--magenta); }
  
  /* Background colored section */
  .ayurvedam-about-content .dark-section {
    background: linear-gradient(145deg, var(--leaf), #4a1128);
    color: var(--ivory);
  }
  .ayurvedam-about-content .dark-section .eyebrow { color: var(--gold); }
  .ayurvedam-about-content .dark-section h2, 
  .ayurvedam-about-content .dark-section h4 { color: var(--ivory); }
  .ayurvedam-about-content .dark-section p { color: #f5dfe7; }
  .ayurvedam-about-content .dark-section .feature-card {
    background: rgba(255,255,255,0.05);
    border-color: rgba(255,255,255,0.1);
  }
  .ayurvedam-about-content .dark-section .feature-card:hover {
    background: rgba(255,255,255,0.1);
    border-color: rgba(255,255,255,0.25);
  }

  /* ===== CTA Section ===== */
  .ayurvedam-about-content .final-cta {
    background: linear-gradient(135deg, var(--leaf) 0%, #3a0d1e 100%);
    color: var(--ivory); text-align: center; padding: 110px 0;
  }
  .ayurvedam-about-content .final-cta h2 { color: var(--ivory); font-size: clamp(32px, 4.5vw, 52px); margin: 16px 0 24px; }
  .ayurvedam-about-content .final-cta p { max-width: 600px; margin: 0 auto 40px; color: #f5dfe7; font-size: 18px; }

  /* Responsive */
  @media (max-width: 1024px) {
    .ayurvedam-about-content .intro-grid { grid-template-columns: 1fr; gap: 48px; }
    .ayurvedam-about-content .intro-image-wrapper { max-width: 600px; margin: 0 auto; }
  }
  @media (max-width: 768px) {
    .ayurvedam-about-content .vm-grid { grid-template-columns: 1fr; }
    .ayurvedam-about-content section { padding: 60px 0; }
  }
  @media (max-width: 600px) {
    .ayurvedam-about-content .vm-card { padding: 32px 24px; }
    .ayurvedam-about-content .feature-grid { grid-template-columns: 1fr; }
  }
`
      }} />
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-74 current_page_item menu-item-99"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/about-us">ABOUT AYURVEDAM FOUNDATION</a></li>
...
<ul class="sub-menu elementor-nav-menu--dropdown">
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-74 current_page_item menu-item-99"><a aria-current="page" class="elementor-sub-item elementor-item-active" href="/about-us" tabindex="-1">ABOUT AYURVEDAM FOUNDATION</a></li>
...
<div class="elementor elementor-74" data-elementor-id="74" data-elementor-post-type="page" data-elementor-type="wp-page">
<div class="elementor-element elementor-element-5389d1d e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="5389d1d">
<div class="elementor-element elementor-element-9d03692 elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="9d03692" data-widget_type="html.default">
<div class="elementor-widget-container">
<!-- Google Fonts -->
...
<div class="ayurvedam-about-content">
<!-- HERO SECTION -->
<section class="about-hero">
<div class="wrap">
<span class="eyebrow">About Us</span>
<h1>Ayurvedam Foundation</h1>
<p class="lead">Preserving Ancient Wisdom, Inspiring Modern Healthcare</p>
</div>
</section>
<!-- MODERN SPLIT INTRO WITH OVERLAPPING IMAGES -->
<section>
<div class="wrap">
<div class="intro-grid">
<div class="intro-text">
<span class="eyebrow">Our Story</span>
<h2>A Bridge to Modern Wellness</h2>
<p>Ayurvedam Foundation is a dedicated platform committed to the promotion, preservation, advancement, and global recognition of Ayurveda—the timeless science of life that has guided human health and well-being for thousands of years. Established with a vision to strengthen the Ayurvedic ecosystem, the Foundation serves as a bridge between classical Ayurvedic wisdom and the evolving healthcare needs of modern society.</p>
<p>In an age where lifestyle disorders, mental stress, chronic illnesses, and environmental challenges are increasing at an unprecedented rate, Ayurveda offers a holistic and sustainable approach to health.</p>
<div class="blockquote">
            "Every great movement begins with a vision. Our shared commitment is to the advancement and global recognition of Ayurveda."
          </div>
<p>Through educational initiatives, scientific conferences, professional networking, research promotion, public awareness campaigns, and strategic collaborations, the Foundation works tirelessly to create opportunities that empower practitioners, researchers, students, institutions, and wellness seekers across the nation and beyond.</p>
</div>
<!-- Premium Overlapping Image Layout -->
<div class="intro-image-wrapper">
<img alt="Ayurvedam Foundation Team Gathering" class="img-main" decoding="async" src="/uploads/2025/03/IMG-20250319-WA0060.jpg"/>
<img alt="Ayurveda Educational Session" class="img-overlap" decoding="async" src="/uploads/2025/03/IMG-20250319-WA0075.jpg"/>
</div>
</div>
</div>
</section>
...
<h3>Global Respect &amp; Accessibility</h3>
<p>To establish Ayurveda as a globally respected, scientifically validated, and universally accessible system of holistic healthcare that empowers individuals and communities to achieve optimal health, wellness, and quality of life.</p>
<p>We envision a future where Ayurveda is recognized not merely as an alternative system of medicine but as an essential component of integrated healthcare, contributing significantly to preventive health, disease management, and overall well-being.</p>
</div>
<div class="vm-card">
<span class="eyebrow">Our Mission</span>
<h3>Growth Through Innovation</h3>
<p>Our mission is to preserve the authentic wisdom of Ayurveda while promoting its growth through education, research, innovation, collaboration, and public engagement. We strive to:</p>
<ul>
<li>Promote awareness of Ayurvedic principles and practices.</li>
<li>Encourage scientific research and evidence-based approaches.</li>
<li>Support professional excellence among practitioners and educators.</li>
<li>Create opportunities for collaboration and networking.</li>
<li>Facilitate dialogue between traditional knowledge and modern healthcare.</li>
</ul>
</div>
</div>
</div>
...
<h2>More than an organization; a movement.</h2>
<p>We bring together diverse stakeholders from across the Ayurvedic community, aiming to strengthen every pillar of the Ayurvedic ecosystem.</p>
</div>
<div class="feature-grid">
<div class="feature-card">
<h4>Ayurvedic Physicians</h4>
<p>Promoting clinical excellence and professional growth.</p>
</div>
<div class="feature-card">
<h4>Academicians</h4>
<p>Encouraging educational advancement and knowledge dissemination.</p>
</div>
<div class="feature-card">
<h4>Researchers</h4>
<p>Supporting scientific inquiry and evidence-based practices.</p>
</div>
<div class="feature-card">
<h4>Students</h4>
<p>Providing opportunities for learning, mentorship, and career development.</p>
</div>
<div class="feature-card">
<h4>Institutions</h4>
<p>Facilitating collaborations that strengthen academic and professional ecosystems.</p>
</div>
<div class="feature-card">
<h4>Industry Partners &amp; Enthusiasts</h4>
<p>Building connections that contribute to innovation and promoting healthier lifestyles.</p>
</div>
</div>
</div>
</section>
<!-- WHY AYURVEDA MATTERS (DARK SECTION) -->
<section class="dark-section">
<div class="wrap">
<div class="section-head">
<span class="eyebrow">Why Ayurveda Matters Today</span>
<h2>A Holistic Approach for the Modern World</h2>
<p>The modern world faces numerous health challenges including lifestyle disorders, mental health concerns, and chronic diseases. Ayurveda offers a unique perspective:</p>
</div>
<div class="feature-grid">
<div class="feature-card">
<span class="eyebrow">Prevention Before Cure</span>
<h4>Maintaining Health</h4>
<p>Maintaining health through balanced living rather than waiting for disease to develop.</p>
</div>
<div class="feature-card">
<span class="eyebrow">Individualized Care</span>
<h4>Personalized Approach</h4>
<p>Recognizing that every individual is unique and requires personalized approaches to health.</p>
</div>
<div class="feature-card">
<span class="eyebrow">Mind-Body Harmony</span>
<h4>Interconnected Wellness</h4>
<p>Addressing physical, emotional, mental, and spiritual well-being as interconnected aspects of health.</p>
</div>
<div class="feature-card">
<span class="eyebrow">Natural Healing</span>
<h4>Holistic Interventions</h4>
<p>Utilizing natural therapies, lifestyle modifications, dietary guidance, and holistic interventions.</p>
</div>
<div class="feature-card">
<span class="eyebrow">Sustainable Wellness</span>
<h4>Aligning with Nature</h4>
<p>Encouraging long-term health practices that align with nature and promote balance.</p>
</div>
</div>
</div>
</section>
<!-- CORE OBJECTIVES & WHAT WE DO -->
<section>
<div class="wrap">
<div class="section-head">
<span class="eyebrow">Our Core Objectives &amp; Activities</span>
<h2>What We Do</h2>
<p>By creating meaningful platforms for interaction and collaboration, we aim to strengthen every pillar of the Ayurvedic ecosystem.</p>
</div>
<div class="feature-grid">
<div class="feature-card">
<h4>Promote Authentic Ayurveda</h4>
<p>Dedicated to preserving classical foundations while ensuring relevance in contemporary healthcare settings.</p>
</div>
<div class="feature-card">
<h4>Organize National Conferences</h4>
<p>Hosting prestigious events like Yashobhoomi for knowledge sharing, scientific discussions, and networking.</p>
</div>
<div class="feature-card">
<h4>Encourage Research &amp; Innovation</h4>
<p>Promoting clinical studies, academic collaborations, and evidence-based approaches.</p>
</div>
<div class="feature-card">
<h4>Create Professional Networks</h4>
<p>Programs and events that create opportunities for professionals and institutions to connect and collaborate.</p>
</div>
<div class="feature-card">
<h4>Support Future Generations</h4>
<p>Encouraging student participation, mentorship opportunities, and leadership development.</p>
</div>
<div class="feature-card">
<h4>Enhance Public Awareness</h4>
<p>Educating communities about preventive healthcare and healthy living through community outreach.</p>
</div>
</div>
</div>
</section>
...
<div class="wrap">
<span class="eyebrow" style="color: var(--gold);">Join Our Mission</span>
<h2>Connect • Collaborate • Contribute • Grow</h2>
<p>The journey of Ayurveda is a journey toward balance, harmony, and holistic wellness. Whether you are a practitioner, researcher, educator, student, institution, industry partner, or wellness enthusiast, we invite you to become part of our growing community.</p>
<p style="font-family: 'Fraunces', serif; font-size: 24px; color: var(--gold); margin-top: 30px;">Welcome to Ayurvedam Foundation. 🌿🙏</p>
</div>
</section>
</div> </div>
</div>
